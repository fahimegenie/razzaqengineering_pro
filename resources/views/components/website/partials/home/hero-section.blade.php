                    ...
                    <div class="row align-items-center h-100">
                                ...
                                @if($value->s_description)
                                    <p class="text-white opacity-90 lead mb-4 animate__animated animate__fadeInUp animate__delay-1s"
                                       style="max-width: 600px; font-size: 1.1rem; line-height: 1.8;">
                                        {{ Str::limit($value->s_description, 250) }}
                                    </p>
                                @endif
                                
                                {{-- Feature Points --}}
                                @if($value->s_t1 || $value->s_t2 || $value->s_t3)
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            @if($value->s_t1)
                                                <div class="feature-item d-flex align-items-center bg-white bg-opacity-10 rounded-pill px-4 py-2 backdrop-blur">
                                                    ...
                                                    <span class="text-white fw-medium">{{ $value->s_t1 }}</span>
                                                </div>
                                            @endif
                                            @if($value->s_t2)
                                                <div class="feature-item d-flex align-items-center bg-white bg-opacity-10 rounded-pill px-4 py-2 backdrop-blur">
                                                    <i class="fas fa-check-circle text-success me-2"></i>
                                                    <span class="text-white fw-medium">{{ $value->s_t2 }}</span>
                                                </div>
                                            @endif
                                            @if($value->s_t3)
                                                <div class="feature-item d-flex align-items-center bg-white bg-opacity-10 rounded-pill px-4 py-2 backdrop-blur">
                                                    <i class="fas fa-check-circle text-success me-2"></i>
                                                    <span class="text-white fw-medium">{{ $value->s_t3 }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5 d-none d-lg-flex align-items-center justify-content-center">
                            <div class="hero-illustration animate__animated animate__fadeInRight animate__delay-1s">
                                {{-- You can add a secondary image or keep empty --}}
                                @if(!empty($value->s_video))
