<div class="fleet-page" 
    ...
    <div class="flt-mobile-cta d-lg-none">
        ...
        <a href="{{ route('quote.index') }}" class="flt-mobile-btn flt-mobile-quote">
                ...
                <div class="col-lg-8" data-aos="fade-up">
                    <nav aria-label="breadcrumb">
                        <ol class="flt-breadcrumb">
                            <li><a href="{{ route('home.index') }}"><i class="fas fa-home me-1"></i> Home</a></li>
                    ...
                    <div class="flt-hero-stats">
                        <div class="flt-stat-item">
                            <span class="flt-stat-number">{{ $fleetItems->total() }}+</span>
                            <span class="flt-stat-label">Machines</span>
                        </div>
                        <div class="flt-stat-item">
                            <span class="flt-stat-number">{{ $categories->count() }}+</span>
    ...
    <section class="flt-main-section">
        <div class="container">
            ...
            @if($fleetItems->count() > 0)
                <div class="row g-4" wire:key="fleet-{{ $selectedCategory }}-{{ md5($search) }}">
                    @foreach($fleetItems as $item)
                        <div class="col-lg-4 col-md-6" 
                             data-aos="fade-up" 
                             data-aos-delay="{{ ($loop->index % 3) * 80 }}" 
                             wire:key="fleet-item-{{ $item->id }}">
                            <div class="flt-card">
                                <div class="flt-card-image">
                                    <img src="{{ $item->image_url }}" alt="{{ $item->title }}" loading="lazy">
                                    @if($item->category)
                                        <div class="flt-card-badges">
                                            <span class="flt-badge-category">{{ $item->category->name }}</span>
                                        </div>
                                    @endif
                                ...
                                <div class="flt-card-body">
                                    ...
                                    @if($item->manufacturer || $item->model_number)
                                        <div class="flt-card-specs">
                                            @if($item->manufacturer)
                                                <span class="flt-spec"><i class="fas fa-industry"></i> {{ $item->manufacturer }}</span>
                                            @endif
                                            @if($item->model_number)
                                                <span class="flt-spec"><i class="fas fa-tag"></i> {{ $item->model_number }}</span>
                                            @endif
                                        </div>
                                    @endif
                                    ...
                                    <div class="flt-card-footer">
                                        ...
                                        <a href="{{ route('quote.index') }}" class="flt-card-quote">
    ...
    <section class="flt-final-cta">
        <div class="container text-center">
            ...
            <div class="flt-final-cta-buttons">
                <a href="{{ route('quote.index') }}" class="flt-btn flt-btn-lg flt-btn-accent">
...
.flt-hero-bg {
    ...
    background: url('{{ asset("images/fleet-hero-bg.jpg") }}') center/cover no-repeat;
