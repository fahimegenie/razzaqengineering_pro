<div class="quote-page-wrapper">
    ...
    <section class="page-hero position-relative d-flex align-items-center" 
             style="background: linear-gradient(135deg, rgba(0,86,179,0.92) 0%, rgba(40,167,69,0.88) 100%), url('{{ asset('assets/images/quote-banner.jpg') }}') center/cover no-repeat; min-height: 350px;">
        ...
        <div class="container">
                ...
                <div class="row justify-content-center" data-aos="zoom-in">
                    <div class="col-lg-7">
                        <div class="card border-0 shadow-lg rounded-4 p-5 text-center">
                            ...
                            <h2 class="fw-bold mb-3">Thank You, {{ $submitted_quote_name }}!</h2>
                            ...
                            <p class="text-muted mb-4">
                                ...
                                <span class="badge bg-gradient text-white px-3 py-2">
                                    {{ str_pad($submitted_quote_id, 5, '0', STR_PAD_LEFT) }}
                                </span>
                            </p>
            ...
            @else
                ...
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-lg rounded-4 p-4 p-lg-5">
                            ...
                            {{-- Progress Bar --}}
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="fw-semibold small text-muted">Step {{ $current_step }} of {{ $total_steps }}</span>
                                        <span class="fw-semibold small text-gradient">{{ $this->stepLabel }}</span>
                                    </div>
                                    <div class="progress" style="height: 6px; border-radius: 10px;">
                                        <div class="progress-bar bg-gradient" 
                                            role="progressbar" 
                                            style="width: {{ $this->progressPercentage }}%; transition: width 0.5s ease;"
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        @for($i = 1; $i <= $total_steps; $i++)
                                            <button wire:click="goToStep({{ $i }})" 
                                                    class="btn btn-sm {{ $current_step == $i ? 'btn-gradient' : ($current_step > $i ? 'btn-success' : 'btn-light') }} rounded-circle"
                                                    style="width:30px;height:30px;padding:0;line-height:30px;font-size:12px;"
                                                    {{ $i > $current_step ? 'disabled' : '' }}>
                                                {{ $current_step > $i ? '✓' : $i }}
                                            </button>
                                        @endfor
                                    </div>
                            ...
                            <form wire:submit="submitQuote" id="quoteForm">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" wire:model.blur="full_name" class="form-control border-start-0 ps-0 @error('full_name') is-invalid @enderror" placeholder="Enter your full name">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" wire:model.blur="phone" class="form-control border-start-0 ps-0 @error('phone') is-invalid @enderror" placeholder="+92 300 1234567">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" wire:model.blur="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" placeholder="email@example.com">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        class="form-control border-start-0 ps-0 @error('service_type') is-invalid @enderror" 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" 
                                                        ...
                                                        class="form-control border-start-0 ps-0 @error('project_location') is-invalid @enderror" 
                                                        placeholder="e.g., Lahore, DHA Phase 5, Plot #123...">
                                                </div>
                                                @error('project_location') <small class="text-danger">{{ $message }}</small> @enderror
                                ...
                                - Any other relevant details..."></textarea>
                                                @error('project_details') <small class="text-danger">{{ $message }}</small> @enderror
                                                <div class="d-flex justify-content-between">
                                                    <small class="text-muted">Min 10 characters required</small>
                                                    <small class="text-muted">{{ strlen($project_details) }}/5000</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-section mb-4 animate__animated animate__fadeIn">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="file" wire:model="attachment" class="form-control @error('attachment') is-invalid @enderror" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx">
                                                ...
                                                @if($attachment)
                                                    <small class="text-success mt-1 d-block">
                                                        <i class="fas fa-check-circle me-1"></i> File ready: {{ $attachment->getClientOriginalName() }}
                                                    </small>
                                                @endif
                    ...
                    {{-- Right Sidebar (same as controller version) --}}
                    <div class="col-lg-4" data-aos="fade-left">
                                ...
                                @foreach([
                                    ...
                                    <li class="mb-3 d-flex align-items-start">
                                        <div class="bg-green-light rounded-circle p-2 me-3 mt-1">
                                            <i class="fas fa-{{ $item['icon'] }} text-success small"></i>
                                        </div>
                                        <div>
                        ...
                        @if($recentProjects->count())
                            <div class="card border-0 shadow-lg rounded-4 p-4">
                                ...
                                <a href="{{ url('projects') }}" class="btn btn-sm btn-outline-primary w-100 mt-3 rounded-pill">View All Projects</a>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row g-4 text-center">
                    @foreach([
                        ...
                        <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="{{ $stat['delay'] }}">
                            <div class="p-4 rounded-4 bg-light">
                                <i class="fas fa-{{ $stat['icon'] }} text-success fa-2x mb-2"></i>
                                <h4 class="fw-bold text-dark mb-1">{{ $stat['count'] }}</h4>
