        ...
        <div class="container">
            <div class="row align-items-center" style="min-height: 280px;">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    @elseif($errorMessage || !$city || !$service)
                        {{-- Error State --}}
                        <h1 class="cs-hero-title">{{ $errorMessage ?? 'Service Not Available' }}</h1>
                        <p class="cs-hero-subtitle">
                            We couldn't find the service you're looking for. Please explore our available services.
                        </p>
                        <div class="d-flex gap-3 flex-wrap mt-3">
                            <a href="{{ route('home.services') }}" class="btn btn-light rounded-pill px-4 fw-bold">
                                <i class="fas fa-tools me-2"></i> Browse Services
                            </a>
                            <a href="{{ url('/') }}" class="btn btn-outline-light rounded-pill px-4 fw-bold">
                    ...
                    @else
                        ...
                        <p class="cs-hero-subtitle">
                            Professional {{ strtolower($service->os_name) }} services in {{ $city->name }}. 
...
<section class="city-contact-strip">
            ...
            @elseif($errorMessage || !$city || !$service)
                ...
                <div class="cs-error-card" data-aos="fade-up">
                    ...
                    <div class="mt-4 d-flex flex-wrap gap-3 justify-content-center">
                        <a href="{{ route('home.services') }}" class="btn btn-gradient rounded-pill px-4 fw-bold">
                            <i class="fas fa-tools me-2"></i> Browse All Services
                        </a>
                        <a href="{{ url('/') }}" class="btn btn-outline-primary rounded-pill px-4 fw-bold">
                            <i class="fas fa-home me-2"></i> Back to Home
                        </a>
                        <a href="{{ route('home.contact') }}" class="btn btn-outline-primary rounded-pill px-4 fw-bold">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'rcc-core-cutting']) }}" class="text-decoration-none">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'diamond-drilling']) }}" class="text-decoration-none">
                                    <div class="p-3 bg-light rounded-3 text-center">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'wall-sawing']) }}" class="text-decoration-none">
                                    <div class="p-3 bg-light rounded-3 text-center">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8" data-aos="fade-up">
                        ...
                        <div class="cs-intro mb-5">
                            ...
                            @else
                                ...
                                <p class="text-muted">
                                    With over <strong>24+ years of experience</strong> and <strong>500+ completed projects</strong> across Pakistan, we guarantee 100% client satisfaction. We offer <strong>24/7 emergency services</strong> with rapid response times across all areas of {{ $city->name }}.
                                </p>
                            @endif
                        </div>
                                            ...
                                            <div class="cs-project-card">
                                                ...
                                                <div class="p-3">
                                                    <h5 class="fw-bold mb-1">
                                                        <a href="{{ route('project.detail', ['slug' => $project->p_slug ?? $project->id]) }}" class="text-dark text-decoration-none">
                                                            {{ $project->p_title }}
                                                        </a>
                                                    </h5>
                                                    @if($project->p_location)
                                                        <small class="text-muted">
                                                            <i class="fas fa-map-marker-alt me-1"></i> {{ $project->p_location }}
                                                        </small>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @foreach($testimonials as $testimonial)
                                        <div class="col-md-6">
                                            <div class="cs-testimonial-card">
                                                <div class="mb-2">
                                                    @for($i = 1; $i <= 5; $i++)
                                                        <i class="fas fa-star{{ $i <= ($testimonial->t_rating ?? 5) ? ' text-warning' : ' text-muted' }} small"></i>
                                                    @endfor
                                                </div>
                                                <p class="text-muted small mb-2">
                                                    "{{ Str::limit($testimonial->t_content, 120) }}"
                                                </p>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    @endif
                                                    <div>
                                                        <strong class="small">{{ $testimonial->t_name }}</strong>
                                                        @if($testimonial->t_location)
                                                            <br><small class="text-muted">{{ $testimonial->t_location }}</small>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-4" data-aos="fade-left">
                        ...
                        <div class="cs-sidebar-card mb-4">
                            ...
                            <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="btn btn-outline-success w-100 rounded-pill py-2 fw-bold mt-2">
                                <i class="fas fa-phone-alt me-2"></i> {{ $settings->mobile_phone_1 ?? '+92 304 8902805' }}
                            </a>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" 
                               target="_blank" 
                            ...
                            <div class="cs-sidebar-card mb-4">
                                ...
                                <ul class="list-unstyled mb-0">
                                    @foreach($otherCities as $otherCity)
                                        <li class="mb-2">
                                            <a href="{{ url($otherCity->slug . '/' . $service->os_slug) }}" class="cs-sidebar-link">
                                                <i class="fas fa-chevron-right small me-2"></i>
                                                {{ $service->os_name }} in {{ $otherCity->name }}
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="cs-sidebar-card">
                                ...
                                <ul class="list-unstyled mb-0">
                                    @foreach($relatedServices as $relatedService)
                                        <li class="mb-2">
                                            <a href="{{ url($city->slug . '/' . $relatedService->os_slug) }}" class="cs-sidebar-link">
                                                <i class="fas fa-chevron-right small me-2"></i>
                                                {{ $relatedService->os_name }}
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
    ...
    <section class="cs-final-cta">
        <div class="container text-center">
            <h2 class="fw-bold mb-3">
                @if($city && $service)
                    Need {{ $service->os_name }} in {{ $city->name }}?
                @else
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="{{ route('quote.index') }}" class="btn btn-gradient rounded-pill px-5 py-3 fw-bold">
                    <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                </a>
                <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="btn btn-outline-primary rounded-pill px-5 py-3 fw-bold">
...
.cs-hero::before {
    ...
    position: absolute;
    inset: 0;
    background: url('{{ asset("images/city-hero-bg.jpg") }}') center/cover no-repeat;
