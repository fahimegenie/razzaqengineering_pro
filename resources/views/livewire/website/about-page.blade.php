<div class="abt-page" 
     x-data="{ 
        activeTab: 'mission',
        showTeamModal: @entangle('showTeamModal'),
        selectedMember: @entangle('selectedMember'),
    ...
    <div class="abt-mobile-cta d-lg-none">
        ...
        <a href="{{ route('quote.index') }}" class="abt-mobile-btn abt-mobile-quote">
    ...
    <section class="abt-hero">
        ...
        @endphp
        <div class="abt-hero-bg" style="background-image: url('{{ $heroBg }}');"></div>
            ...
            <div class="row align-items-center min-vh-30">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <div class="abt-hero-badge">
                        ...
                        {{ max(0, now()->year - 2002) }}+ Years of Excellence
                    </div>
                    
                    <h1 class="abt-hero-title">
                        {{ !empty($about) ? $about->about_title : 'About Razzaq Engineering' }}
                    </h1>
                    ...
                    <div class="abt-hero-stats">
                        <div class="abt-stat-item">
                            <span class="abt-stat-number">{{ $stats['projects'] ?? 500 }}+</span>
                            <span class="abt-stat-label">Projects</span>
                        </div>
                        <div class="abt-stat-item">
                            <span class="abt-stat-number">{{ $stats['clients'] ?? 300 }}+</span>
                            <span class="abt-stat-label">Clients</span>
                        </div>
                        <div class="abt-stat-item">
                            <span class="abt-stat-number">{{ $stats['cities'] ?? 9 }}+</span>
                            <span class="abt-stat-label">Cities</span>
                        </div>
                        <div class="abt-stat-item">
                            <span class="abt-stat-number">{{ $stats['team'] ?? 50 }}+</span>
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-right">
                        <div class="abt-image-wrapper">
                            ...
                            <div class="abt-exp-badge">
                                <span class="abt-exp-num">{{ max(0, now()->year - 2002) }}+</span>
                    ...
                    <div class="col-lg-6" data-aos="fade-left">
                        ...
                        <h2 class="abt-section-title">
                            {{ !empty($about) ? $about->about_title : "Pakistan's Leading Engineering Services" }}
                        </h2>
                        
                        <div class="abt-description">
                            <p>
                                {{ !empty($about) && !empty($about->about_description_1) 
                            ...
                            <p>
                                {{ !empty($about) && !empty($about->about_description_2) 
                        ...
                        <div class="abt-quick-stats">
                            <div class="abt-quick-stat">
                                <span class="abt-qs-number">{{ $stats['projects'] ?? 500 }}+</span>
                                <span class="abt-qs-label">Projects Done</span>
                            </div>
                            <div class="abt-quick-stat">
                                <span class="abt-qs-number">{{ $stats['clients'] ?? 300 }}+</span>
                                <span class="abt-qs-label">Happy Clients</span>
                            </div>
                            <div class="abt-quick-stat">
                                <span class="abt-qs-number">{{ $stats['cities'] ?? 9 }}+</span>
                                <span class="abt-qs-label">Cities Covered</span>
                            </div>
                        </div>
                        
                        <div class="abt-cta-row">
                            <a href="{{ route('quote.index') }}" class="abt-btn abt-btn-accent">
                                ...
                                <div class="row g-4 align-items-center">
                                    <div class="col-md-5">
                                        ...
                                        <h3 class="abt-tab-title">
                                            {{ !empty($about) && !empty($about->mission_title) ? $about->mission_title : 'Our Mission' }}
                                        </h3>
                                    </div>
                                    <div class="col-md-7">
                            ...
                            <div class="abt-tab-card">
                                <div class="row g-4 align-items-center">
                                    <div class="col-md-5">
                                        ...
                                        <h3 class="abt-tab-title">
                                            {{ !empty($about) && !empty($about->vision_title) ? $about->vision_title : 'Our Vision' }}
                                        </h3>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="abt-tab-text">
                            ...
                            <div class="abt-tab-card">
                                <div class="row g-4 align-items-center">
                                    <div class="col-md-5">
                                        ...
                                        <h3 class="abt-tab-title">
                                            {{ !empty($about) && !empty($about->values_title) ? $about->values_title : 'Our Core Values' }}
                                        </h3>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="abt-tab-text">
                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        @foreach($team->take(4) as $member)
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                                <div class="abt-team-card" wire:click="showMemberDetail({{ $member->id }})">
                    ...
                    @if($team->count() > 4)
                        <div class="text-center mt-4">
                            <a href="{{ url('team') }}" class="abt-btn abt-btn-outline">
    ...
    <section class="abt-final-cta">
        <div class="container text-center">
            ...
            <div class="abt-final-cta-buttons">
                <a href="{{ route('quote.index') }}" class="abt-btn abt-btn-lg abt-btn-accent">
                    <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                </a>
        ...
        <div class="abt-modal-content" @click.stop>
            ...
            @if($selectedMember)
                <div class="row g-4">
                    ...
                    <div class="col-md-7">
                        <h2 class="abt-modal-name">{{ $selectedMember->ot_name }}</h2>
                        <span class="abt-modal-role">{{ $selectedMember->ot_designation }}</span>
                        ...
                        <div class="abt-modal-contact">
                            @if($selectedMember->ot_email)
                                <a href="mailto:{{ $selectedMember->ot_email }}" class="abt-contact-link">
                                    <i class="fas fa-envelope"></i> {{ $selectedMember->ot_email }}
                                </a>
                            @endif
                            @if($selectedMember->ot_phone)
                                <a href="tel:{{ $selectedMember->ot_phone }}" class="abt-contact-link">
                                    <i class="fas fa-phone-alt"></i> {{ $selectedMember->ot_phone }}
                                </a>
                            @endif
                        </div>
                        ...
                        <div class="abt-modal-social">
                            @if($selectedMember->ot_fb)
                                <a href="{{ $selectedMember->ot_fb }}" target="_blank" class="abt-social-btn">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            @endif
                            @if($selectedMember->ot_linkedin)
                                <a href="{{ $selectedMember->ot_linkedin }}" target="_blank" class="abt-social-btn">
