<div class="rfp-page">
    ...
    <div class="rfp-mobile-cta d-lg-none">
        <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="rfp-mobile-btn rfp-mobile-call" aria-label="Call {{ $settings->site_name ?? 'Razzaq Engineering Services' }}">
            <i class="fas fa-phone-alt"></i> Call
        </a>
        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" target="_blank" class="rfp-mobile-btn rfp-mobile-whatsapp" aria-label="Chat on WhatsApp">
            <i class="fab fa-whatsapp"></i> WhatsApp
        </a>
        <a href="{{ route('quote.index') }}" class="rfp-mobile-btn rfp-mobile-quote" aria-label="Get Free Quote">
            ...
            <div class="row align-items-center">
                <div class="col-lg-10" data-aos="fade-up">
                    ...
                    <p class="rfp-hero-subtitle">
                        Our commitment to fair and transparent refund practices at {{ $settings->site_name ?? 'Razzaq Engineering Services' }}
                    </p>
                    @if($lastUpdated)
                ...
                <div class="rfp-content-col" data-aos="fade-up">
                    <div class="rfp-content-card">
                        ...
                        <div class="rfp-section" id="introduction">
                            ...
                            <p>At <strong>{{ $settings->site_name ?? 'Razzaq Engineering Services' }}</strong>, we are committed to providing high-quality engineering services and products. This Refund & Cancellation Policy outlines our procedures for refunds, returns, and cancellations.</p>
                        ...
                        <div class="rfp-section rfp-contact-section" id="contact">
                            ...
                            <div class="rfp-contact-info">
                                <div class="rfp-contact-item">
                                    ...
                                    <div><strong>{{ $settings->site_name ?? 'Razzaq Engineering Services' }}</strong>@if($settings->address_1)<span>{{ $settings->address_1 }}</span>@endif</div>
                                </div>
                                <div class="rfp-contact-item">
                                    <i class="fas fa-phone-alt"></i>
                                    <div><strong>Phone</strong><a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}">{{ $settings->mobile_phone_1 ?? '+92 304 8902805' }}</a></div>
                                </div>
                                <div class="rfp-contact-item">
                                    <i class="fas fa-envelope"></i>
                                    <div><strong>Email</strong><a href="mailto:{{ $settings->email_primary ?? 'info@razzaqengineering.com' }}">{{ $settings->email_primary ?? 'info@razzaqengineering.com' }}</a></div>
                                </div>
                                <div class="rfp-contact-item">
                    ...
                    <div class="rfp-sidebar-wrapper">
                        <div class="rfp-sidebar">
                            ...
                            <div class="rfp-sidebar-card rfp-sidebar-cta">
                                ...
                                <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="rfp-btn rfp-btn-accent w-100"><i class="fas fa-phone-alt me-2"></i> {{ $settings->mobile_phone_1 ?? '+92 304 8902805' }}</a>
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" target="_blank" class="rfp-btn rfp-btn-whatsapp w-100 mt-2"><i class="fab fa-whatsapp me-2"></i> WhatsApp Chat</a>
                            </div>
    ...
    <section class="rfp-final-cta">
        <div class="container text-center">
            ...
            <div class="rfp-final-cta-buttons">
                <a href="{{ route('home.contact') }}" class="rfp-btn rfp-btn-accent"><i class="fas fa-envelope me-2"></i> Contact Support</a>
                <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="rfp-btn rfp-btn-white-outline-dark"><i class="fas fa-phone-alt me-2"></i> Call Now</a>
            </div>
        </div>
    </section>
...
.rfp-hero-overlay{position:absolute;inset:0;background:url('{{ asset("images/pattern-dots.svg") }}') repeat;opacity:.04}
