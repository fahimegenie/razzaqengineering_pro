<div class="city-page" 
     x-data="{ 
        activeServiceTab: @entangle('activeServiceTab'),
    ...
    <div class="city-mobile-cta d-lg-none" x-show="scrolled" x-transition>
        <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="city-mobile-btn city-mobile-call">
            <i class="fas fa-phone-alt"></i> <span>Call</span>
        </a>
        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" target="_blank" class="city-mobile-btn city-mobile-whatsapp">
            <i class="fab fa-whatsapp"></i> <span>WhatsApp</span>
        </a>
        <a href="{{ route('quote.index') }}" class="city-mobile-btn city-mobile-quote">
    ...
    <div class="city-floating-actions d-none d-lg-block">
        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" target="_blank" class="city-float-btn city-float-whatsapp" title="Chat on WhatsApp">
            <i class="fab fa-whatsapp"></i>
        </a>
        <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="city-float-btn city-float-call" title="Call Now">
            <i class="fas fa-phone-alt"></i>
        </a>
        <a href="{{ route('quote.index') }}" class="city-float-btn city-float-quote" title="Get Free Quote">
        ...
        <div class="container position-relative">
            <div class="row align-items-center" style="min-height: 380px;">
                <div class="col-lg-8" data-aos="fade-up" data-aos-duration="800">
                    ...
                    @elseif($errorMessage || !$city)
                        {{-- Error State --}}
                        <div class="city-hero-badge">
                            <i class="fas fa-exclamation-triangle pulse"></i> 
                            <span>Page Not Available</span>
                        </div>
                        <h1 class="city-hero-title">{{ $errorMessage ?? 'City Not Found' }}</h1>
                        ...
                        <div class="city-hero-cta">
                            <a href="{{ route('home.services') }}" class="city-btn city-btn-lg city-btn-accent">
                                <i class="fas fa-tools me-2"></i> Browse All Services
                            </a>
                            <a href="{{ url('/') }}" class="city-btn city-btn-lg city-btn-white-outline">
                    ...
                    @else
                        ...
                        <div class="city-hero-badge animate__animated animate__fadeInDown">
                            ...
                            <span>{{ $city->name }} • {{ count($services) }}+ Services Available</span>
                        </div>
                        <h1 class="city-hero-title animate__animated animate__fadeInUp">
                            Professional Engineering Services in {{ $city->name }}
                        </h1>
                        <p class="city-hero-subtitle animate__animated animate__fadeInUp">
                            Razzaq Engineering provides expert RCC core cutting, diamond drilling, wall sawing, plumbing & fire fighting services across {{ $city->name }} with <strong>24+ years</strong> of excellence.
                        </p>
                        
                        <div class="city-hero-stats animate__animated animate__fadeInUp">
                            <div class="city-stat-item">
                                <span class="city-stat-number">{{ count($services) }}+</span>
                                <span class="city-stat-label">Services</span>
                            </div>
                            <div class="city-stat-divider"></div>
                            <div class="city-stat-item">
                                <span class="city-stat-number">{{ count($projects) }}+</span>
                        ...
                        <div class="city-hero-cta animate__animated animate__fadeInUp">
                            <a href="{{ route('quote.index') }}" class="city-btn city-btn-lg city-btn-accent">
                                <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                                <span class="btn-shine"></span>
                            </a>
                            <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="city-btn city-btn-lg city-btn-white-outline">
                ...
                @if(!$isLoading && !$errorMessage && $city)
    ...
    {{-- Add this after the Trust Bar section --}}
{{-- Professional CTA Strip --}}
        ...
        <div class="container">
            ...
            @if($isLoading)
                <div class="city-state-box">
                    ...
                    <p class="text-muted">Fetching the best engineering services in {{ $city->name ?? 'your city' }}</p>
                </div>
            ...
            @elseif($errorMessage || !$city)
                <div class="city-error-card" data-aos="fade-up">
                    ...
                    <h4 class="fw-bold mt-4">{{ $errorMessage ?? 'City Not Found' }}</h4>
                    <p class="text-muted mb-4">Don't worry! We provide engineering services across Pakistan.</p>
                    
                    <div class="city-action-buttons">
                        <a href="{{ route('home.services') }}" class="city-btn city-btn-accent">
                            <i class="fas fa-tools me-2"></i> Browse All Services
                        </a>
                        <a href="{{ url('/') }}" class="city-btn city-btn-outline">
                            <i class="fas fa-home me-2"></i> Back to Home
                        </a>
                        <a href="{{ route('home.contact') }}" class="city-btn city-btn-outline">
                    ...
                    <div class="city-popular-services mt-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'rcc-core-cutting']) }}" class="popular-service-link">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'diamond-drilling']) }}" class="popular-service-link">
                                    <div class="popular-service-card">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('service.detail.slug', ['slug' => 'wall-sawing']) }}" class="popular-service-link">
                                    <div class="popular-service-card">
            ...
            @else
                ...
                @if(count($services) > 0)
                    <div class="city-section-header" data-aos="fade-up">
                        ...
                        <h2>Engineering Services in {{ $city->name }}</h2>
                        <p>Explore our comprehensive range of professional services available across {{ $city->name }}</p>
                    </div>
                    ...
                    <div class="city-tabs-wrapper" data-aos="fade-up">
                        <div class="city-tabs-scroll">
                            @foreach($services as $service)
                                <button class="city-tab-btn {{ $activeServiceTab == $service->id ? 'active' : '' }}"
                                        wire:click="switchServiceTab({{ $service->id }})"
                                        wire:key="tab-{{ $service->id }}">
                                    @if($service->os_icon)
                                        <span class="tab-icon"><i class="{{ $service->os_icon }}"></i></span>
                                    @endif
                                    <span>{{ $service->os_name }}</span>
                                </button>
                            @endforeach
                        </div>
                    </div>
                    ...
                    @if(count($serviceDetails) > 0)
                        <div class="city-details-grid" data-aos="fade-up" wire:key="details-{{ $activeServiceTab }}">
                            @foreach($serviceDetails as $detail)
                                <div class="city-detail-card">
                                    @if($detail->sd_image1)
                                        <div class="city-detail-image">
                                            <img src="{{ $detail->image1_url }}" alt="{{ $detail->sd_title }}" loading="lazy">
                                            <div class="detail-image-overlay">
                                                <a href="{{ route('service.detail.slug', ['slug' => $services->find($activeServiceTab)->os_slug ?? '']) }}" class="detail-view-btn">
                                    ...
                                    <div class="city-detail-body">
                                        <h4>{{ $detail->sd_title }}</h4>
                                        <p>{{ Str::limit(strip_tags($detail->sd_description), 150) }}</p>
                                        @if($detail->sd_t1 || $detail->sd_t2 || $detail->sd_t3)
                                            <ul class="city-detail-features">
                                                @foreach([$detail->sd_t1, $detail->sd_t2, $detail->sd_t3] as $feature)
                                                    @if($feature)
                                        ...
                                        @endif
                                        <a href="{{ route('service.detail.slug', ['slug' => $services->find($activeServiceTab)->os_slug ?? '']) }}" class="city-detail-link">
                            ...
                            @foreach($services as $service)
                                <div class="col-lg-4 col-md-6">
                                    <div class="city-service-card">
                                        ...
                                        @endif
                                        <h3>
                                            <a href="{{ route('city.service', ['city' => $city->slug, 'service' => $service->os_slug]) }}">
                                                {{ $service->os_name }}
                                            </a>
                                        </h3>
                                        <p>{{ Str::limit(strip_tags($service->os_short_description ?? $service->os_description), 100) }}</p>
                                        <div class="city-service-footer">
                                            <a href="{{ route('city.service', ['city' => $city->slug, 'service' => $service->os_slug]) }}" class="city-service-link">
                ...
                @else
                    <div class="city-empty-state" data-aos="fade-up">
                        ...
                        <p>We're updating our services for {{ $city->name }}. Contact us for more information.</p>
                        <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="city-btn city-btn-accent mt-3">
                ...
                @if(count($projects) > 0)
                    <div class="city-section-header mt-5" data-aos="fade-up">
                        ...
                        <h2>Projects in {{ $city->name }}</h2>
                        <p>Showcasing our completed and ongoing projects across {{ $city->name }}</p>
                    </div>
                    <div class="row g-4" data-aos="fade-up">
                        @foreach($projects->take($showAllProjects ? count($projects) : 3) as $project)
                            <div class="col-lg-4 col-md-6">
                                <div class="city-project-card">
                                    <div class="city-project-image">
                                        <img src="{{ $project->image_url }}" alt="{{ $project->p_title }}" loading="lazy">
                                        @if($project->p_status)
                                            <span class="city-project-status status-{{ $project->p_status }}">
                                                {{ ucfirst($project->p_status) }}
                                            </span>
                                        @endif
                                        <div class="project-image-overlay">
                                            <a href="{{ route('project.detail', ['slug' => $project->p_slug ?? $project->id]) }}" class="project-view-btn">
                                    ...
                                    <div class="city-project-body">
                                        <h4>
                                            <a href="{{ route('project.detail', ['slug' => $project->p_slug ?? $project->id]) }}">
                                                {{ $project->p_title }}
                                            </a>
                                        </h4>
                                        <p>{{ Str::limit(strip_tags($project->p_short_description ?? $project->p_description), 80) }}</p>
                ...
                @if(count($testimonials) > 0)
                    ...
                    <div class="row g-4" data-aos="fade-up">
                        @foreach($testimonials->take($showAllTestimonials ? count($testimonials) : 3) as $testimonial)
                            <div class="col-lg-4 col-md-6">
                                <div class="city-testimonial-card">
                                    <div class="city-testimonial-stars">
                                        @for($i = 1; $i <= 5; $i++)
                                            <i class="fas fa-star{{ $i <= $testimonial->t_rating ? '' : ' empty' }}"></i>
                                        @endfor
                                    </div>
                                    <div class="city-testimonial-quote">
                                        <i class="fas fa-quote-left"></i>
                                    </div>
                                    <p class="city-testimonial-content">"{{ Str::limit($testimonial->t_content, 150) }}"</p>
                                    <div class="city-testimonial-author">
                                        @if($testimonial->t_image)
                                            <img src="{{ $testimonial->image_url }}" alt="{{ $testimonial->t_name }}" loading="lazy">
                                        @else
                                            <div class="testimonial-avatar-placeholder">
                                                {{ strtoupper(substr($testimonial->t_name, 0, 1)) }}
                                            </div>
                                        @endif
                                        <div>
                                            <strong>{{ $testimonial->t_name }}</strong>
                                            <span>{{ $testimonial->t_designation }}@if($testimonial->t_company), {{ $testimonial->t_company }}@endif</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="city-cta-card mt-5" data-aos="zoom-in">
                    ...
                    <div class="row align-items-center position-relative">
                        <div class="col-lg-8">
                            <h3>Need Engineering Services in {{ $city->name }}?</h3>
                            <p>Contact us today for a free consultation and competitive estimate. Our team is ready to help!</p>
                        </div>
                        <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                            <a href="{{ route('quote.index') }}" class="city-btn city-btn-accent city-btn-lg">
                                <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                                <span class="btn-shine"></span>
                            </a>
                        </div>
    ...
    <section class="city-final-cta">
        <div class="container text-center">
            <div class="city-final-content" data-aos="fade-up">
                ...
                <h2>Ready to Start Your Project in {{ $city->name ?? 'Your City' }}?</h2>
                ...
                <div class="city-final-cta-buttons">
                    ...
                    <a href="tel:{{ $settings->mobile_phone_1 ?? '+923048902805' }}" class="city-btn city-btn-lg city-btn-white-outline-dark">
                        <i class="fas fa-phone-alt me-2"></i> Call Now
                    </a>
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805') }}" target="_blank" class="city-btn city-btn-lg city-btn-whatsapp">
...
.city-hero-bg { position:absolute;inset:0;background:url('{{ asset("images/city-hero-bg.jpg") }}')center/cover no-repeat;filter:brightness(0.25); }
