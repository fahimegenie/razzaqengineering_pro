            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.projects.categories.index') }}">Project Categories</a></li>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body text-center">
                            @if($imagePreview)
                                <img src="{{ $imagePreview }}" class="rounded mb-2" style="width:100%;max-height:200px;object-fit:cover;">
                            @else
                    ...
                    <a href="{{ route('admin.projects.categories.index') }}" class="btn btn-outline-secondary w-100"><i class="bi bi-x-lg me-1"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
