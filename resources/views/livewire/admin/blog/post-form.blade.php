<div>
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h1 class="mb-0 fs-3">{{ $isEditing ? 'Edit Post' : 'Create New Post' }}</h1></div>
                <div class="col-sm-6">
            ...
            <div class="row g-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('bp_title') is-invalid @enderror" 
                                           wire:model.live="bp_title" placeholder="Enter post title...">
                                    @error('bp_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('bp_content') is-invalid @enderror" 
                                              rows="15" wire:model="bp_content" placeholder="Write your post content here..."></textarea>
                                    @error('bp_content')<div class="invalid-feedback">{{ $message }}</div>@enderror
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('bp_status') is-invalid @enderror" wire:model="bp_status">
                                    <option value="draft">Draft</option>
                                    <option value="published">Published</option>
                                    <option value="scheduled">Scheduled</option>
                                    <option value="archived">Archived</option>
                                </select>
                                @error('bp_status')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror" wire:model="category_id">
                                    ...
                                    @foreach($categories as $cat)
                                        <option value="{{ $cat->id }}">{{ $cat->bc_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('author_id') is-invalid @enderror" wire:model="author_id">
                                    ...
                                    @foreach($allTags as $tag)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{ $tag->id }}" 
                                                   wire:model="selectedTags" id="tag_{{ $tag->id }}">
                                            <label class="form-check-label small" for="tag_{{ $tag->id }}">{{ $tag->bt_name }}</label>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body">
                            @if($imagePreview)
                                <img src="{{ $imagePreview }}" class="img-fluid rounded mb-2" style="max-height: 200px; width: 100%; object-fit: cover;">
                            @endif
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body">
                            @if($bannerPreview)
                                <img src="{{ $bannerPreview }}" class="img-fluid rounded mb-2" style="max-height: 150px; width: 100%; object-fit: cover;">
                            @endif
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mb-2" wire:loading.attr="disabled">
                        <span wire:loading.remove wire:target="save,publish,saveDraft">
                            <i class="bi bi-check-lg me-1"></i> {{ $isEditing ? 'Update Post' : 'Create Post' }}
                        </span>
