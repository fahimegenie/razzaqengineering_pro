<div>
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="mb-0 fs-3">{{ $isEditing ? 'Edit Category' : 'Create New Category' }}</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('bc_name') is-invalid @enderror" 
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('bc_slug') is-invalid @enderror" 
                                        ...
                                        @error('bc_slug')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body text-center">
                            <div class="mb-3">
                                @if($imagePreview)
                                    <img src="{{ $imagePreview }}" class="rounded" 
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mb-2" wire:loading.attr="disabled">
                        <span wire:loading.remove wire:target="save">
                            <i class="bi bi-check-lg me-1"></i> {{ $isEditing ? 'Update Category' : 'Create Category' }}
                        </span>
                        <span wire:loading wire:target="save">
                            <span class="spinner-border spinner-border-sm me-1"></span> Saving...
                        </span>
                    </button>
                    <a href="{{ route('admin.blog.categories.index') }}" class="btn btn-outline-secondary w-100">
