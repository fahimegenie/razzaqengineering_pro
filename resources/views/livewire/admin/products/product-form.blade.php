<div>
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h1 class="mb-0 fs-3">{{ $isEditing ? 'Edit Product' : 'Create New Product' }}</h1></div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('p_name') is-invalid @enderror" 
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body text-center">
                            @if($imagePreview)
                                <img src="{{ $imagePreview }}" class="rounded mb-2" 
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row g-2 mb-3">
                                    @foreach($existingGallery as $i => $img)
                                        <div class="col-4 position-relative">
                                            <img src="{{ $img }}" class="img-thumbnail w-100" style="height:70px;object-fit:cover;">
                                            <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 rounded-circle" 
                                                    wire:click="removeExistingGalleryImage({{ $i }})" style="width:22px;height:22px;padding:0;font-size:10px;">
                                                <i class="bi bi-x"></i>
                                            </button>
                                        </div>
                                    @endforeach
                            ...
                            @if(count($galleryPreviews) > 0)
                                <div class="row g-2 mb-3">
                                    @foreach($galleryPreviews as $i => $prev)
                                        <div class="col-4 position-relative">
                                            <img src="{{ $prev }}" class="img-thumbnail w-100" style="height:70px;object-fit:cover;">
                                            <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 rounded-circle" 
                                                    wire:click="removeGalleryImage({{ $i }})" style="width:22px;height:22px;padding:0;font-size:10px;">
                                                <i class="bi bi-x"></i>
                                            </button>
                                        </div>
                                    @endforeach
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mb-2" wire:loading.attr="disabled">
                        <span wire:loading.remove wire:target="save">
                            <i class="bi bi-check-lg me-1"></i> {{ $isEditing ? 'Update Product' : 'Create Product' }}
                        </span>
