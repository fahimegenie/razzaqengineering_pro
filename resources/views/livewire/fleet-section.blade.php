{{-- resources/views/livewire/fleet-section.blade.php --}}
                            ...
                            <div class="fleet-card-img">
                                ...
                                <div class="fleet-img-overlay">
                                    <a href="#" 
                                       ...
                                       @click.prevent="$dispatch('open-fleet-detail', { id: {{ $item->id }} })">
                                        <i class="fas fa-search-plus me-2"></i> View Details
                                    </a>
                                </div>
                                <span class="fleet-category">
                                    {{ strtoupper($item->category->name ?? 'EQUIPMENT') }}
                                </span>
                            </div>
                            <div class="fleet-card-body">
                                <h3 class="fleet-title">{{ $item->title }}</h3>
                                <p class="fleet-desc">{{ Str::limit($item->description, 120) }}</p>
    ...
    <div x-data="{ 
        ...
        init() {
            window.addEventListener('open-fleet-detail', (e) => {
                @this.call('getFleetItem', e.detail.id).then(item => {
