...
#[Title('Refund Policy - Razzaq Engineering Services')]
class RefundPolicyPage extends Component
{
    ...
    {
        $seo = $this->getSeoData();
        return view('livewire.website.refund-policy-page', [
