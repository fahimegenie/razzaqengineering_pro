        ...
        <form wire:submit="save">
            <div class="row g-3">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" wire:model="seo_page_type">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" wire:model="seo_slug">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" rows="2" wire:model="seo_description" placeholder="SEO description"></textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Meta Keywords</label>
                                    <input type="text" class="form-control" wire:model="seo_keywords" placeholder="keyword1, keyword2">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Focus Keyword</label>
                                    <input type="text" class="form-control" wire:model="seo_focus_keyword" placeholder="Primary keyword">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" wire:model="seo_main_title" placeholder="Website / Brand name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-header bg-transparent">
                            <h3 class="card-title mb-0 fw-semibold"><i class="bi bi-robot me-2"></i>Robots and Indexing</h3>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control font-monospace" rows="8" wire:model="seo_schema_markup" placeholder="Paste JSON-LD schema here..."></textarea>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-header bg-transparent">
                            <h3 class="card-title mb-0 fw-semibold"><i class="bi bi-graph-up me-2"></i>Analytics and Tracking</h3>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="range" class="form-range" wire:model="seo_sitemap_priority" min="0" max="100">
                                    <small><?php echo e($seo_sitemap_priority); ?>%</small>
                                </div>
                                <div class="col-md-3">
