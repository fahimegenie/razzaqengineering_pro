        ...
        <section class="crd-hero">
            ...
            <div class="container position-relative">
                <div class="row" data-aos="fade-up">
                    <div class="col-lg-8">
                        <nav class="crd-breadcrumb"><ol><li><a href="<?php echo e(url('/')); ?>"><i class="fas fa-home me-1"></i> Home</a></li><li><a href="<?php echo e(route('careers')); ?>">Careers</a></li><li class="active"><?php echo e($job->title); ?></li></ol></nav>
                        <div class="crd-hero-badge"><i class="fas fa-briefcase"></i> <?php echo e($job->department ?? 'Job Opening'); ?></div>
                        <h1 class="crd-hero-title"><?php echo e($job->title); ?></h1>
                        <div class="crd-hero-meta">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->location): ?><span><i class="fas fa-map-marker-alt"></i> <?php echo e($job->location); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->job_type): ?><span><i class="fas fa-clock"></i> <?php echo e($job->job_type); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8" data-aos="fade-up">
                        <div class="crd-content-card">
                            <div class="crd-content-body">
                                ...
                                <div class="crd-description"><?php echo $job->description; ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->requirements): ?>
                                    ...
                                    <div class="crd-description"><?php echo $job->requirements; ?></div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->benefits): ?>
                                    ...
                                    <div class="crd-description"><?php echo $job->benefits; ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="fade-left">
                        <div class="crd-sidebar">
                            <div class="crd-sidebar-card crd-sidebar-cta">
                                ...
                                <a href="<?php echo e(route('careers.apply', ['slug' => $job->slug])); ?>" class="crd-btn crd-btn-accent w-100"><i class="fas fa-paper-plane me-2"></i> Apply Now</a>
                            </div>
                            <div class="crd-sidebar-card">
                                <h5 class="crd-sidebar-title">Job Overview</h5>
                                <div class="crd-info-list">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->department): ?><div class="crd-info-item"><i class="fas fa-building"></i><span>Department</span><strong><?php echo e($job->department); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->location): ?><div class="crd-info-item"><i class="fas fa-map-marker-alt"></i><span>Location</span><strong><?php echo e($job->location); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->job_type): ?><div class="crd-info-item"><i class="fas fa-clock"></i><span>Job Type</span><strong><?php echo e($job->job_type); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->salary_range): ?><div class="crd-info-item"><i class="fas fa-money-bill-wave"></i><span>Salary</span><strong><?php echo e($job->salary_range); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->experience): ?><div class="crd-info-item"><i class="fas fa-briefcase"></i><span>Experience</span><strong><?php echo e($job->experience); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->qualification): ?><div class="crd-info-item"><i class="fas fa-graduation-cap"></i><span>Qualification</span><strong><?php echo e($job->qualification); ?></strong></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedJobs->count() > 0): ?>
                                <div class="crd-sidebar-card"><h5 class="crd-sidebar-title">Related Jobs</h5>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <a href="<?php echo e(route('careers.detail', ['slug' => $rj->slug])); ?>" class="crd-related-item"><div><h6><?php echo e($rj->title); ?></h6><small><?php echo e($rj->location); ?> • <?php echo e($rj->job_type); ?></small></div><i class="fas fa-chevron-right"></i></a>
...
</style><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/career-detail-page.blade.php ENDPATH**/ ?>