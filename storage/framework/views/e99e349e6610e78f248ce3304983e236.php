<div class="about-page-wrapper">
            ...
            <div class="row align-items-center" style="min-height: 280px;">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <h1 class="about-hero-title">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about)): ?>
                            <?php echo e($about->about_title); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLoading && !$errorMessage): ?>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="about-img-wrapper">
                        ...
                        <div class="about-exp-badge">
                            <span class="exp-num"><?php echo e($stats['experience']); ?>+</span>
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    ...
                    <div class="about-text">
                        <p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->about_description_1)): ?>
                                <?php echo e($about->about_description_1); ?>
                        ...
                        <p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->about_description_2)): ?>
                                <?php echo e($about->about_description_2); ?>
                    ...
                    <div class="about-quick-stats">
                        <div class="quick-stat">
                            <span class="qs-number"><?php echo e($stats['projects']); ?>+</span>
                            <span class="qs-label">Projects Done</span>
                        </div>
                        <div class="quick-stat">
                            <span class="qs-number"><?php echo e($stats['clients']); ?>+</span>
                            <span class="qs-label">Happy Clients</span>
                        </div>
                        <div class="quick-stat">
                            <span class="qs-number"><?php echo e($stats['cities']); ?>+</span>
                            <span class="qs-label">Cities Covered</span>
                        </div>
                    </div>
                    
                    
                    <a href="<?php echo e(route('quote.index')); ?>" class="btn-about-cta">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <h3 class="m-tab-title">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->mission_title)): ?>
                                            <?php echo e($about->mission_title); ?>
                                ...
                                <div class="col-md-7">
                                    <div class="m-tab-text">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->mission_description)): ?>
                                            <p><?php echo e($about->mission_description); ?></p>
                                        <?php else: ?>
                        ...
                        <div class="m-tab-card">
                            <div class="row g-4 align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <h3 class="m-tab-title">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->vision_title)): ?>
                                ...
                                <div class="col-md-7">
                                    <div class="m-tab-text">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->vision_description)): ?>
                                            <p><?php echo e($about->vision_description); ?></p>
                                        <?php else: ?>
                        ...
                        <div class="m-tab-card">
                            <div class="row g-4 align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <h3 class="m-tab-title">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->values_title)): ?>
                                            <?php echo e($about->values_title); ?>
                                ...
                                <div class="col-md-7">
                                    <div class="m-tab-text">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($about) && !empty($about->values_description)): ?>
                                            <p><?php echo e($about->values_description); ?></p>
                                        <?php else: ?>
        ...
        <div class="container">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($team->count() > 4): ?>
                <div class="text-center mt-4">
                    <a href="<?php echo e(url('team')); ?>" class="btn-team-all">
    ...
    <!-- ============================================
         TEAM MODAL
         ============================================ -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showTeamModal && $selectedMember): ?>
        ...
        <div class="modal-custom">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-7">
                    <h3 class="fw-bold"><?php echo e($selectedMember->ot_name); ?></h3>
                    <p class="text-success fw-semibold"><?php echo e($selectedMember->ot_designation); ?></p>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMember->ot_email): ?>
                        <p><i class="fas fa-envelope text-success me-2"></i> <?php echo e($selectedMember->ot_email); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMember->ot_phone): ?>
                        <p><i class="fas fa-phone text-success me-2"></i> <?php echo e($selectedMember->ot_phone); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/about-page.blade.php ENDPATH**/ ?>