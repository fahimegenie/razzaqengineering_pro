...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-lg-4" data-aos="fade-left">
                        ...
                        <!-- Recent Projects -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($recentProjects)): ?>
                                        ...
                                        <div class="col-6">
                                            <a href="<?php echo e(url('project/'.$rp->id)); ?>" class="text-decoration-none">
                                                <div class="position-relative rounded-3 overflow-hidden" style="height:80px;">
                                                    <img src="<?php echo e(asset($rp->p_image)); ?>" alt="<?php echo e($rp->p_title); ?>" class="w-100 h-100" style="object-fit:cover;">
