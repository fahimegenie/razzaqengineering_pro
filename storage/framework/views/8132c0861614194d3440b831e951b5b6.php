<div>
    ...
    <div class="container-fluid">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastCleared): ?>
        <div class="alert alert-info d-flex justify-content-between align-items-center">
            <span><i class="bi bi-clock-history me-2"></i> Last cache cleared: <strong><?php echo e($lastCleared); ?></strong></span>
        </div>
        ...
        <div class="card shadow-sm border-0 mb-3">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-<?php echo e($result['type']); ?> py-2 mb-1">
                    <i class="bi bi-<?php echo e($result['type'] === 'success' ? 'check-circle' : ($result['type'] === 'error' ? 'exclamation-circle' : 'info-circle')); ?> me-2"></i>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm bg-primary bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <h5 class="mb-0 mt-1"><?php echo e($viewCacheCount); ?></h5>
                        <small class="text-muted">View Files</small>
                        <div class="small text-primary"><?php echo e($viewCacheSize); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm bg-success bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <h5 class="mb-0 mt-1"><?php echo e($appCacheSize); ?></h5>
                ...
                <div class="card border-0 shadow-sm bg-info bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <span class="d-block mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($configCacheExists): ?>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm bg-warning bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <span class="d-block mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($routeCacheExists): ?>
                            <span class="badge bg-success">Cached</span>
                            <?php else: ?>
                            <span class="badge bg-secondary">Not Cached</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm bg-danger bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <span class="d-block mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($eventCacheExists): ?>
                            <span class="badge bg-success">Cached</span>
                            <?php else: ?>
                            <span class="badge bg-secondary">Not Cached</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm bg-dark bg-opacity-10 h-100">
                    <div class="card-body text-center py-3">
                        ...
                        <h5 class="mb-0 mt-1"><?php echo e($compiledCount); ?></h5>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body text-center py-4">
                        ...
                        <div class="small text-muted mb-2"><?php echo e($viewCacheCount); ?> files (<?php echo e($viewCacheSize); ?>)</div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body text-center py-4">
                        ...
                        <div class="small text-muted mb-2">Size: <?php echo e($appCacheSize); ?></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body text-center py-4">
                        ...
                        <div class="small text-muted mb-2">Status: <?php echo $configCacheExists ? '<span class="text-success">Cached</span>' : '<span class="text-secondary">Not Cached</span>'; ?></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body text-center py-4">
                        ...
                        <div class="small text-muted mb-2">Status: <?php echo $routeCacheExists ? '<span class="text-success">Cached</span>' : '<span class="text-secondary">Not Cached</span>'; ?></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body text-center py-4">
                        ...
                        <div class="small text-muted mb-2">Status: <?php echo $eventCacheExists ? '<span class="text-success">Cached</span>' : '<span class="text-secondary">Not Cached</span>'; ?></div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isClearing): ?>
            ...
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-exclamation-triangle me-2"></i><?php echo e($confirmTitle); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/admin/clear-cache.blade.php ENDPATH**/ ?>