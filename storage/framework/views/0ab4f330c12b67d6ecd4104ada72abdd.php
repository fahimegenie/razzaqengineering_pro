...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <div class="ml-auto px-2">
      <a class="navbar-link d-none" id="cancel_selection">
        ...
        <span class="d-none d-lg-inline"><?php echo e(trans('laravel-filemanager::lfm.menu-cancel-selection')); ?></span>
      </a>
    </div>
  ...
  <nav class="bg-light fixed-bottom border-top d-none" id="actions">
    <a data-action="openfolder" data-multiple="false"><i class="fas fa-folder-open"></i><?php echo e(trans('laravel-filemanager::lfm.btn-open')); ?></a>
    ...
    <div id="main">
      ...
      <div class="action-bar">
        <label class="multiple-selection-toggle-label">
          ...
          <?php echo e(trans('laravel-filemanager::lfm.menu-multiple')); ?>

        </label>

        <div class="search-bar">
          <input type="text" name="keyword" id="keyword" placeholder="<?php echo e(trans('laravel-filemanager::lfm.placeholder-keyword')); ?>" class="form-control">
          <button type="button" id="keyword-button" class="btn btn-outline-primary"><?php echo e(trans('laravel-filemanager::lfm.btn-search')); ?></button>
          <button type="button" id="keyword-reset-button" class="btn btn-outline-secondary"><?php echo e(trans('laravel-filemanager::lfm.btn-reset')); ?></button>
        </div>
      </div>
  ...
  <div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary w-100" data-dismiss="modal"><?php echo e(trans('laravel-filemanager::lfm.btn-close')); ?></button>
          <button type="button" class="btn btn-primary w-100" data-dismiss="modal" id="confirm-button-yes"><?php echo e(trans('laravel-filemanager::lfm.btn-confirm')); ?></button>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH /var/www/html/projects/saif/razzaq-engineering/vendor/unisharp/laravel-filemanager/resources/views/index.blade.php ENDPATH**/ ?>