<div>
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6"><ol class="breadcrumb float-sm-end"><li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Home</a></li><li class="breadcrumb-item active">Product Categories</li></ol></div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row g-3 mb-3">
            <div class="col-6"><div class="card border-0 shadow-sm bg-primary text-white"><div class="card-body text-center py-3"><i class="bi bi-grid display-6"></i><h3 class="mb-0 mt-1"><?php echo e($totalCategories); ?></h3><small>Total</small></div></div></div>
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 text-end"><a href="<?php echo e(route('admin.products.categories.create')); ?>" class="btn btn-primary w-100"><i class="bi bi-plus-lg"></i> Add</a></div>
                </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    <thead class="table-light"><tr><th width="40"><input type="checkbox" class="form-check-input" <?php if($selectAll): echo 'checked'; endif; ?> wire:click="toggleSelectAll"></th><th width="60">Img</th><th>Name</th><th>Slug</th><th>Products</th><th>Status</th><th>Order</th><th width="120">Actions</th></tr></thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-info"><?php echo e($cat->products_count); ?></span></td>
                            ...
                            <td><div class="btn-group btn-group-sm"><a href="<?php echo e(route('admin.products.categories.edit', $cat->id)); ?>" class="btn btn-primary"><i class="bi bi-pencil"></i></a><button class="btn btn-danger" wire:click="confirmDelete(<?php echo e($cat->id); ?>)"><i class="bi bi-trash"></i></button></div></td>
                        </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr><td colspan="8" class="text-center py-5"><i class="bi bi-grid display-4 text-muted d-block"></i>No categories found<br><a href="<?php echo e(route('admin.products.categories.create')); ?>" class="btn btn-sm btn-primary mt-2"><i class="bi bi-plus-lg"></i> Add Category</a></td></tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
                </table>
            </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/admin/products/category-list.blade.php ENDPATH**/ ?>