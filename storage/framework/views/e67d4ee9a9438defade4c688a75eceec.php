<div class="pdp-wrapper"
    ...
    <section class="pdp-section">
        <div class="container">
            ...
            <?php elseif($project): ?>
                <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('pdp-content-{{ $project->id }}', get_defined_vars()); ?>wire:key="pdp-content-<?php echo e($project->id); ?>">
