            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center" data-aos="zoom-in">
                    <div class="card border-0 shadow-lg rounded-4 p-5">
                        ...
                        <h2 class="fw-bold mb-3">Thank You, <?php echo e($quoteName); ?>!</h2>
                        <p class="text-muted mb-2">Your quote request has been received successfully.</p>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quoteId): ?>
                            <p class="text-muted mb-4">
                                <strong>Reference #:</strong> 
                                <span class="badge bg-gradient text-white px-3 py-2 fs-6">
                                    <?php echo e($this->formattedQuoteId); ?>
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-center">
                            ...
                            <a href="<?php echo e(url('get-quote')); ?>" class="btn btn-outline-primary px-4 py-2 rounded-pill fw-semibold">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/quote-thank-you.blade.php ENDPATH**/ ?>