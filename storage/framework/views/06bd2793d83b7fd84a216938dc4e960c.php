...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <iframe src="/<?php echo e(config('lfm.url_prefix') ?: 'filemanager'); ?>" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
      </div>
    </div>
  </div>
  ...
  <script>
   var route_prefix = "/<?php echo e(config('lfm.url_prefix') ?: 'filemanager'); ?>";
  </script>
...
<?php /**PATH /var/www/html/projects/saif/razzaq-engineering/vendor/unisharp/laravel-filemanager/resources/views/demo.blade.php ENDPATH**/ ?>