                        ...
                        <div class="col-md-4">
                            ...
                            <div class="dropdown">
                                ...
                                <button 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($os_icon): ?>

                                        <span class="d-flex align-items-center">
                                            <i class="<?php echo e($os_icon); ?> fs-5 me-2 text-primary"></i>

                                            <span>
                                                <?php echo e($iconOptions[$os_icon] ?? 'Selected Icon'); ?>
                                ...
                                <ul class="dropdown-menu w-100 shadow-sm"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $iconOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        <li>
                                            ...
                                            <button 
                                                ...
                                                wire:click="$set('os_icon', '<?php echo e($val); ?>')">


                                                <i class="<?php echo e($val); ?> fs-5 text-primary me-3"></i>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($os_icon): ?>
                                ...
                                <div class="mt-3 p-3 border rounded text-center bg-light">
                                    ...
                                    <i class="<?php echo e($os_icon); ?> display-5 text-primary"></i>


                                    <div class="fw-semibold mt-2">
                                        <?php echo e($os_name ?: 'Service Name'); ?>
