<div class="service-detail-page" 
    ...
    <div class="sd-mobile-cta d-lg-none">
        ...
        <a href="<?php echo e(route('quote.index')); ?>" class="sd-mobile-btn sd-mobile-quote">
    ...
    <section class="sd-hero">
        <div class="sd-hero-bg" style="background-image: url('<?php echo e($currentService->os_image ? $currentService->image_url : asset('images/hero-construction.jpg')); ?>');"></div>
            ...
            <div class="row align-items-center min-vh-40">
                <div class="col-lg-7" data-aos="fade-up">
                    <nav aria-label="breadcrumb">
                        <ol class="sd-breadcrumb">
                            ...
                            <li class="active"><?php echo e($currentService->os_name ?? 'Service Details'); ?></li>
                        </ol>
                    </nav>
                    ...
                    <h1 class="sd-hero-title">
                        <?php echo e($currentService->os_name ?? $currentDetail->sd_title ?? 'Service Details'); ?>

                    </h1>
                    
                    <p class="sd-hero-subtitle">
                        <?php echo e($currentService->os_short_description ?? 'Professional engineering solutions with 24+ years of excellence'); ?>

                    </p>
                    
                    <div class="sd-hero-cta">
                        <a href="<?php echo e(route('quote.index')); ?>" class="sd-btn sd-btn-lg sd-btn-accent">
                ...
                <div class="col-lg-5 d-none d-lg-block text-center" data-aos="fade-left">
                    <div class="sd-hero-image-wrapper">
                        <img src="<?php echo e($currentDetail->image1_url ?? asset('images/service-default.jpg')); ?>" 
                             alt="<?php echo e($currentService->os_name ?? 'Service'); ?>" 
                             class="sd-hero-image"
                             loading="eager">
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLoading): ?>
                        <div class="sd-state-box" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'sd-loading'; ?>wire:key="sd-loading">
                    ...
                    <?php elseif($errorMessage): ?>
                        <div class="sd-error-card">
                            ...
                            <a href="<?php echo e(route('home.services')); ?>" class="btn btn-primary mt-3">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($services->count() > 1): ?>
                                ...
                                <div class="sd-tabs-container">
                                    ...
                                    <div class="sd-tabs-scroll" id="sdTabsScroll" x-ref="tabsScroll">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <button type="button"
                                                    class="sd-tab-btn <?php echo e($activeServiceId == $service->id ? 'active' : ''); ?>"
                                                    ...
                                                    id="tab-btn-<?php echo e($service->id); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentDetail && $currentService): ?>
                            
                            <div class="sd-content-card" data-aos="fade-up" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'content-'.e($activeDetailId).''; ?>wire:key="content-<?php echo e($activeDetailId); ?>">
                                <div class="sd-image-hero">
                                    <img src="<?php echo e($currentDetail->image1_url); ?>" 
                                         alt="<?php echo e($currentDetail->sd_title); ?>" 
                                         class="sd-img-full"
                                         loading="lazy">
                                    <div class="sd-image-cta-overlay">
                                        <span class="sd-badge-large"><?php echo e($currentService->os_name); ?></span>
                                    </div>
                                </div>
                                
                                <div class="sd-content-body">
                                    <h2 class="sd-section-title"><?php echo e($currentDetail->sd_title); ?></h2>
                                    
                                    <div class="sd-description">
                                        <?php echo Str::words(strip_tags($currentDetail->sd_description), 80, '...'); ?>

                                    </div>
                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Str::wordCount(strip_tags($currentDetail->sd_description)) > 80): ?>
                                        <div x-show="showAllAdvantages" x-transition class="sd-description">
                                            <?php echo $currentDetail->sd_description; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentDetail->sd_t1 || $currentDetail->sd_t2 || $currentDetail->sd_t3): ?>
                                        <div class="sd-features-grid">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [$currentDetail->sd_t1, $currentDetail->sd_t2, $currentDetail->sd_t3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentAdvantages->count() > 0): ?>
                                <div class="sd-content-card" data-aos="fade-up" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'advantages-'.e($activeDetailId).''; ?>wire:key="advantages-<?php echo e($activeDetailId); ?>">
                                    <div class="sd-content-body">
                                        <h3 class="sd-section-title">Service Advantages</h3>
                                        
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $currentAdvantages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $advantage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="sd-accordion-item" 
                                                 :class="{ 'active': activeFaq === <?php echo e($index); ?> }">
                                                <button class="sd-accordion-header" 
                                                        @click="activeFaq = activeFaq === <?php echo e($index); ?> ? null : <?php echo e($index); ?>">
                                                    <span><?php echo e($advantage->sa_title); ?></span>
                                                    <i class="fas fa-chevron-down sd-accordion-arrow"></i>
                                                </button>
                                                <div class="sd-accordion-body" 
                                                     x-show="activeFaq === <?php echo e($index); ?>" 
                                                     x-transition>
                                                    <p><?php echo $advantage->sa_description; ?></p>
                                                    
                                                    <?php $points = array_filter([$advantage->sa_t1, $advantage->sa_t2, $advantage->sa_t3, $advantage->sa_t4]); ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($points)): ?>
                                                        <ul class="sd-accordion-list">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                                <li><i class="fas fa-angle-right"></i> <?php echo e($point); ?></li>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                        </ul>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                ...
                <div class="col-lg-4">
                    <div class="sd-sidebar">
                        ...
                        <div class="sd-sidebar-card sd-sidebar-cta">
                            ...
                            <a href="<?php echo e(route('quote.index')); ?>" class="sd-btn sd-btn-accent w-100">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdfFile && $pdfFile->pdf_name): ?>
                            <div class="sd-sidebar-card">
