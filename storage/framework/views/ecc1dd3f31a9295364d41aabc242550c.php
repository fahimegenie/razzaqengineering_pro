<div class="ppp-page">
    ...
    <div class="ppp-mobile-cta d-lg-none">
        <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="ppp-mobile-btn ppp-mobile-call" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
            <i class="fas fa-phone-alt"></i> Call
        </a>
        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805')); ?>" target="_blank" class="ppp-mobile-btn ppp-mobile-whatsapp" aria-label="Chat on WhatsApp">
            <i class="fab fa-whatsapp"></i> WhatsApp
        </a>
        <a href="<?php echo e(route('quote.index')); ?>" class="ppp-mobile-btn ppp-mobile-quote" aria-label="Get Free Quote">
            ...
            <div class="row align-items-center">
                <div class="col-lg-10" data-aos="fade-up">
                    ...
                    <p class="ppp-hero-subtitle">
                        Your privacy matters. Learn how <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?> collects, uses and protects your information.
                    </p>
                ...
                <div class="col-lg-9" data-aos="fade-up">
                    <div class="ppp-content-card">
                        ...
                        <div class="ppp-section" id="introduction">
                            ...
                            <p><?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?> ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <strong><?php echo e(config('app.url')); ?></strong> or use our services.</p>
                ...
                <div class="col-lg-3" data-aos="fade-left">
                    <div class="ppp-sidebar">
                        ...
                        <div class="ppp-sidebar-card ppp-sidebar-cta">
                            ...
                            <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="ppp-btn ppp-btn-accent w-100" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
    ...
    <section class="ppp-final-cta">
        <div class="container text-center">
            ...
            <div class="ppp-final-cta-buttons">
                <a href="<?php echo e(route('home.contact')); ?>" class="ppp-btn ppp-btn-accent">
                    <i class="fas fa-envelope me-2"></i> Contact Us
                </a>
                <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="ppp-btn ppp-btn-white-outline-dark" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
...
.ppp-hero-overlay { position: absolute; inset: 0; background: url('<?php echo e(asset("images/pattern-dots.svg")); ?>') repeat; opacity: 0.04; }
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/privacy-policy-page.blade.php ENDPATH**/ ?>