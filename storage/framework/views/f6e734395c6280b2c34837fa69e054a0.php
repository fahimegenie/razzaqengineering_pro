<div class="tc-page">
    ...
    <div class="tc-mobile-cta d-lg-none">
        <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="tc-mobile-btn tc-mobile-call" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
            <i class="fas fa-phone-alt"></i> Call
        </a>
        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp_number ?? $settings->mobile_phone_1 ?? '+923048902805')); ?>" target="_blank" class="tc-mobile-btn tc-mobile-whatsapp" aria-label="Chat on WhatsApp">
            <i class="fab fa-whatsapp"></i> WhatsApp
        </a>
        <a href="<?php echo e(route('quote.index')); ?>" class="tc-mobile-btn tc-mobile-quote" aria-label="Get Free Quote">
            ...
            <div class="row align-items-center">
                <div class="col-lg-10" data-aos="fade-up">
                    ...
                    <p class="tc-hero-subtitle">
                        Please read these terms carefully before using our services at <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>
                ...
                <div class="tc-content-col" data-aos="fade-up">
                    <div class="tc-content-card">
                        ...
                        <div class="tc-section" id="introduction">
                            ...
                            <p>Welcome to <strong><?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?></strong> ("Company," "we," "our," "us"). These Terms & Conditions ("Terms") govern your use of our website <strong><?php echo e(config('app.url')); ?></strong> (the "Website") and our engineering services.</p>
                        ...
                        <div class="tc-section" id="definitions">
                            ...
                            <ul>
                                <li><strong>"Company"</strong> refers to <?php echo e($settings->company_name ?? $settings->site_name ?? 'Razzaq Engineering Services'); ?></li>
                                ...
                                <li><strong>"Website"</strong> refers to <?php echo e(config('app.url')); ?> and all subdomains</li>
                        ...
                        <div class="tc-section" id="services">
                            ...
                            <p><?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?> provides professional engineering and construction services including:</p>
                            <ul>
                        ...
                        <div class="tc-section" id="ip">
                            ...
                            <p>All content on this Website, including text, graphics, logos, images, videos, software, and design, is the exclusive property of <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?> and is protected by Pakistani and international copyright laws.</p>
                            <p>You may not:</p>
                            <ul>
                        ...
                        <div class="tc-section" id="liability">
                            ...
                            <p>To the fullest extent permitted by law, <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?> shall not be liable for:</p>
                            <ul>
                        ...
                        <div class="tc-section" id="cancellation">
                            ...
                            <p>For complete details, please refer to our <a href="<?php echo e(route('refund-policy')); ?>">Refund Policy</a>.</p>
                        </div>

                        <div class="tc-section" id="privacy">
                            <h2><span class="tc-section-num">10</span> Privacy Policy</h2>
                            <p>Your privacy is important to us. Our collection and use of personal information is governed by our <a href="<?php echo e(route('privacy-policy')); ?>">Privacy Policy</a>, which is incorporated into these Terms by reference.</p>
                        </div>
                        ...
                        <div class="tc-section" id="law">
                            ...
                            <p>These Terms shall be governed by and construed in accordance with the laws of the Islamic Republic of Pakistan. Any disputes arising from these Terms shall be subject to the exclusive jurisdiction of the courts in <?php echo e($settings->city ?? 'Lahore'); ?>, Pakistan.</p>
                        </div>
                        ...
                        <div class="tc-section tc-contact-section" id="contact">
                            ...
                            <div class="tc-contact-info">
                                <div class="tc-contact-item">
                                    ...
                                    <div>
                                        <strong><?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?></strong>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->address_1): ?><span><?php echo e($settings->address_1); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                                <div class="tc-contact-item">
                                    ...
                                    <div>
                                        <strong>Phone</strong>
                                        <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>"><?php echo e($settings->mobile_phone_1 ?? '+92 304 8902805'); ?></a>
                                    </div>
                                </div>
                                <div class="tc-contact-item">
                                    ...
                                    <div>
                                        <strong>Email</strong>
                                        <a href="mailto:<?php echo e($settings->email_primary ?? 'info@razzaqengineering.com'); ?>"><?php echo e($settings->email_primary ?? 'info@razzaqengineering.com'); ?></a>
                                    </div>
                                </div>
                                <div class="tc-contact-item">
                                    ...
                                    <div>
                                        ...
                                        <span><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->is_24_7): ?> 24/7 - Available All Time <?php else: ?> Monday - Saturday: 9:00 AM - 6:00 PM <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tc-sidebar">
                            ...
                            <div class="tc-sidebar-card">
                                ...
                                <ul class="tc-related-links">
                                    ...
                                    <li><a href="<?php echo e(route('refund-policy')); ?>"><i class="fas fa-undo-alt"></i> Refund Policy</a></li>
                                    ...
                                    <li><a href="<?php echo e(route('home.about')); ?>"><i class="fas fa-info-circle"></i> About Us</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="tc-sidebar-card tc-sidebar-cta">
                                ...
                                <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="tc-btn tc-btn-accent w-100" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
    ...
    <section class="tc-final-cta">
        <div class="container text-center">
            ...
            <div class="tc-final-cta-buttons">
                <a href="<?php echo e(route('quote.index')); ?>" class="tc-btn tc-btn-accent">
                    <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                </a>
                <a href="tel:<?php echo e($settings->mobile_phone_1 ?? '+923048902805'); ?>" class="tc-btn tc-btn-white-outline-dark" aria-label="Call <?php echo e($settings->site_name ?? 'Razzaq Engineering Services'); ?>">
...
.tc-hero-overlay { position: absolute; inset: 0; background: url('<?php echo e(asset("images/pattern-dots.svg")); ?>') repeat; opacity: 0.04; }
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/terms-conditions-page.blade.php ENDPATH**/ ?>