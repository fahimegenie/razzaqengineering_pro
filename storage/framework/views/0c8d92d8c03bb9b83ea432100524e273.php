        ...
        <div class="row g-3 mb-4">
            <div class="col-xl-6 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?php echo e($this->totalCompanies); ?></h3>
                        <p>Total Companies</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?php echo e($this->activeCompanies); ?></h3>
                    ...
                    <div class="col-md-3 text-end">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedItems) > 0): ?>
                            <button type="button" wire:click="bulkDelete" class="btn btn-danger btn-sm me-2">
                                <i class="bi bi-trash"></i> Delete (<?php echo e(count($selectedItems)); ?>)
                            </button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6" x-data="{ showActions: false }"
                        ...
                        <div class="card company-card h-100 border-0 shadow-sm">
                            <div class="company-card-img-wrap">
                                <img src="<?php echo e($item->image1_url); ?>" alt="<?php echo e($item->oc_title); ?>" loading="lazy">
                                <div class="company-select">
                                    <input type="checkbox" wire:model.live="selectedItems" value="<?php echo e($item->id); ?>" class="form-check-input">
                                </div>
                                <span class="company-cat-badge"><?php echo e($item->our_company_category ?? 'General'); ?></span>
                                <span class="company-status-badge <?php echo e($item->is_active ? 'active' : 'inactive'); ?>">
                                    <?php echo e($item->is_active ? 'Active' : 'Inactive'); ?>

                                </span>
                                <div class="company-action-overlay" x-show="showActions" x-transition>
                                    <div class="d-flex gap-1">
                                        <button type="button" wire:click="edit(<?php echo e($item->id); ?>)" class="btn btn-light btn-sm" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <button type="button" wire:click="toggleStatus(<?php echo e($item->id); ?>)" class="btn btn-warning btn-sm" title="Toggle Status">
                                            <i class="bi bi-toggle-<?php echo e($item->is_active ? 'on' : 'off'); ?>"></i>
                                        </button>
                                        <button type="button" wire:click="confirmDelete(<?php echo e($item->id); ?>)" class="btn btn-danger btn-sm" title="Delete">
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-1"><?php echo e($item->oc_title); ?></h5>
                                <p class="text-muted small mb-2"><?php echo e($item->short_description); ?></p>
                                <div class="d-flex flex-wrap gap-2 mb-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->established_year): ?>
                                        <span class="badge bg-info"><i class="bi bi-calendar me-1"></i>Est. <?php echo e($item->established_year); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->company_type): ?>
                                        <span class="badge bg-secondary"><?php echo e($item->company_type); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->company_age > 0): ?>
                                        <span class="badge bg-success"><?php echo e($item->company_age); ?>+ Years</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->has_ceo): ?>
                                    <div class="mt-2 d-flex align-items-center gap-2 border-top pt-2">
                                        <img src="<?php echo e($item->ceo_image_url); ?>" class="rounded-circle" width="32" height="32" style="object-fit:cover;">
                                        <small class="text-muted fw-semibold"><?php echo e($item->ceo_name); ?></small>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                                <small class="text-muted"><i class="bi bi-sort-down me-1"></i>Order: <?php echo e($item->sort_order); ?></small>
                                <small class="text-muted"><i class="bi bi-images me-1"></i><?php echo e($item->image_count); ?> images</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" wire:model="oc_title" class="form-control <?php $__errorArgs = ['oc_title'];
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g., Razzaq Engineering Services">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['oc_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="col-12">
                                ...
                                <div wire:ignore>
                                    <textarea 
                                        ...
                                        class="form-control <?php $__errorArgs = ['oc_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ><?php echo e($oc_description); ?></textarea>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['oc_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="row g-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [1 => 'image1Preview', 2 => 'image2Preview', 3 => 'image3Preview', 4 => 'image4Preview']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $previewVar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="col-md-3">
                                    <div class="border rounded p-2 text-center h-100">
                                        <label class="form-label small fw-semibold">Image <?php echo e($num); ?></label>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->$previewVar): ?>
                                            <img src="<?php echo e($this->$previewVar); ?>" class="img-fluid mb-2 rounded" style="max-height:120px;width:100%;object-fit:cover;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?>
                                                <button type="button" wire:click="removeImage(<?php echo e($itemId); ?>, <?php echo e($num); ?>)" class="btn btn-danger btn-sm w-100 mb-1">
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <input type="file" wire:model="oc_image<?php echo e($num); ?>" class="form-control form-control-sm mt-1" accept="image/*">
                                        <div wire:loading wire:target="oc_image<?php echo e($num); ?>" class="mt-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="border rounded p-2 text-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ceoImagePreview): ?>
                                        <img src="<?php echo e($ceoImagePreview); ?>" class="rounded-circle mb-2" style="width:80px;height:80px;object-fit:cover;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditing): ?>
                                            <button type="button" wire:click="removeCeoImage(<?php echo e($itemId); ?>)" class="btn btn-danger btn-sm w-100 mb-1">
                                                <i class="bi bi-trash"></i> Remove
                                            </button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php else: ?>
                        ...
                        <div class="text-end mt-4 border-top pt-3">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg" wire:loading.attr="disabled">
                                <span wire:loading.remove wire:target="save">
                                    <i class="bi bi-check-lg me-1"></i> <?php echo e($isEditing ? 'Update Company' : 'Create Company'); ?>
            ...
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    editor.model.document.on('change:data', () => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('oc_description', data, false);
                    });
                })
                .catch(error => {
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/admin/our-company/our-company-manager.blade.php ENDPATH**/ ?>