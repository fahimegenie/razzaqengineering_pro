            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                <div class="card shadow-sm border-0 h-100 product-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <small class="text-muted"><i class="bi bi-tag"></i> <?php echo e($product->brand_name); ?></small>
                        ...
                        <small class="text-muted"><?php echo e($product->category->pc_name); ?></small>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <!-- Price Range Display -->
                        <div class="mb-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->p_price && $product->price_to): ?>
                                <h6 class="text-primary mb-0"><?php echo e($product->formatted_price); ?> - <?php echo e($product->formatted_price_to); ?></h6>
                                <small class="text-muted">Price Range</small>
                            <?php elseif($product->p_price): ?>
                                <h6 class="text-primary mb-0"><?php echo e($product->formatted_price); ?></h6>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-5">
                            <img src="<?php echo e($viewProduct->image_url); ?>" class="img-fluid rounded">
                        </div>
                        <div class="col-md-7">
                            <h4><?php echo e($viewProduct->p_name); ?></h4>
                            
                            <!-- Brand Name in Modal -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewProduct->brand_name): ?>
                            <p><strong>Brand:</strong> <?php echo e($viewProduct->brand_name); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            
                            <p><strong>Category:</strong> <?php echo e($viewProduct->category->pc_name ?? 'N/A'); ?></p>
                            
                            <!-- Price Range in Modal -->
                            <p><strong>Price:</strong> 
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewProduct->p_price && $viewProduct->price_to): ?>
                                    <?php echo e($viewProduct->formatted_price); ?> - <?php echo e($viewProduct->formatted_price_to); ?>

                                <?php elseif($viewProduct->p_price): ?>
                                    <?php echo e($viewProduct->formatted_price); ?>
                            ...
                            <p><strong>Stock:</strong> <?php echo $viewProduct->stock_badge; ?></p>
                            <p><strong>Status:</strong> <span class="badge bg-<?php echo e($viewProduct->is_active ? 'success' : 'danger'); ?>"><?php echo e($viewProduct->is_active ? 'Active' : 'Inactive'); ?></span></p>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewProduct->p_short_description): ?>
                            <p><strong>Description:</strong><br><?php echo e($viewProduct->p_short_description); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('admin.products.edit', $viewProduct->id)); ?>" class="btn btn-primary"><i class="bi bi-pencil"></i> Edit</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <p class="text-muted">Are you sure you want to delete "<?php echo e($viewProduct->p_name ?? 'this product'); ?>"?</p>
                </div>
