                    ...
                    <div class="footer-widget">
                        <div class="footer-logo mb-3">
                            <a href="<?php echo e(route('home.index')); ?>">
                                <img src="<?php echo e($footerLogo); ?>" alt="<?php echo e($siteName); ?>" class="footer-logo-img" loading="lazy">
                            </a>
                        </div>
                        <p class="footer-about">
                            <?php echo $settings->footer_aboutus; ?>

                        </p>
                        
                        <div class="footer-contact">
                            <a href="tel:<?php echo e($primaryPhoneClean); ?>" class="footer-contact-link">
                                <span class="footer-contact-icon"><i class="fas fa-phone-alt"></i></span>
                                <div>
                                    <small><?php echo e($is24x7 || $isEmergency ? '24/7 Emergency' : 'Call Us'); ?></small>
                                    <strong><?php echo e($primaryPhone); ?></strong>
                                </div>
                            </a>
                            <a href="mailto:<?php echo e($primaryEmail); ?>" class="footer-contact-link">
                                <span class="footer-contact-icon"><i class="fas fa-envelope"></i></span>
                                <div>
                                    <small>Email Us</small>
                                    <strong><?php echo e($primaryEmail); ?></strong>
                                </div>
                            </a>
                            <div class="footer-contact-link">
                                ...
                                <div>
                                    ...
                                    <strong>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($is24x7): ?> 24/7 Available
                                        <?php elseif($isEmergency): ?> 24/7 Emergency
                                        <?php elseif($settings->working_days && $settings->office_start_time): ?>
                                            <?php echo e($settings->working_days); ?>: <?php echo e($settings->office_start_time); ?> - <?php echo e($settings->office_end_time ?? '6:00 PM'); ?>

                                        <?php else: ?> Mon-Sat: 9AM - 6PM
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $footerServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li><a href="<?php echo e(route('service.detail.slug', ['slug' => $fs->os_slug])); ?>"><?php echo e($fs->os_name); ?></a></li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <li><a href="<?php echo e(route('home.services')); ?>" class="footer-link-highlight">View All →</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $footerProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <li><a href="<?php echo e(route('product.detail', ['slug' => $fp->pc_slug])); ?>"><?php echo e($fp->pc_name); ?></a></li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <li><a href="<?php echo e(route('products')); ?>" class="footer-link-highlight">View All →</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPortfolio): ?><li><a href="<?php echo e(route('gallery')); ?>">Gallery</a></li><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <li><a href="<?php echo e(route('testimonials')); ?>">Testimonials</a></li>
                            <li><a href="<?php echo e(route('blog.index')); ?>">Blog</a></li>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showFaq): ?><li><a href="<?php echo e(route('home.faq')); ?>">FAQ</a></li><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQuoteForm): ?><li><a href="<?php echo e(route('quote.index')); ?>">Get Free Quote</a></li><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <li><a href="<?php echo e(url('sitemap.xml')); ?>" target="_blank">Sitemap</a></li>
                        </ul>
                        ...
                        <div class="footer-social">
                            ...
                            <a href="<?php echo e($settings->facebook_url); ?>" target="_blank" class="footer-social-icon" title="Facebook" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <a href="<?php echo e($settings->instagram_url); ?>" target="_blank" class="footer-social-icon" title="Instagram" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <a href="<?php echo e($settings->tiktok_url); ?>" target="_blank" class="footer-social-icon" title="TikTok" aria-label="TikTok"><i class="fab fa-tiktok"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <a href="<?php echo e($settings->linkedin_url); ?>" target="_blank" class="footer-social-icon" title="LinkedIn" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <a href="<?php echo e($settings->youtube_url); ?>" target="_blank" class="footer-social-icon" title="YouTube" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <a href="<?php echo e($settings->twitter_url); ?>" target="_blank" class="footer-social-icon" title="X/Twitter" aria-label="Twitter"><i class="fab fa-x-twitter"></i></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="footer-cta-inner">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <h3><?php echo e($isEmergency ? '🚨 Emergency Service 24/7' : 'Need Professional Service?'); ?></h3>
                        <p><?php echo e($is24x7 ? 'We\'re available around the clock.' : 'Get in touch for a free consultation.'); ?></p>
                    </div>
                    <div class="col-lg-5 text-lg-end">
                        <div class="footer-cta-buttons">
                            <a href="tel:<?php echo e($primaryPhoneClean); ?>" class="footer-cta-btn footer-cta-call">
                                <i class="fas fa-phone-alt"></i> <?php echo e($primaryPhone); ?>
                            ...
                            <a href="https://wa.me/<?php echo e($whatsappNumberClean); ?>" target="_blank" class="footer-cta-btn footer-cta-whatsapp">
        ...
        <div class="container">
            <div class="footer-bottom-inner">
                <p class="footer-copyright">
                    &copy; <?php echo e(date('Y')); ?> <strong><?php echo e($companyName); ?></strong>. All Rights Reserved.
                </p>
                <div class="footer-bottom-links">
                    <a href="<?php echo e(route('privacy-policy')); ?>">Privacy</a>
                    <a href="<?php echo e(route('terms-conditions')); ?>">Terms</a>
                    <a href="<?php echo e(url('sitemap.xml')); ?>" target="_blank">Sitemap</a>
                </div>
            </div>
        </div>
    </div>
...
</style><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/components/layouts/partials/footer.blade.php ENDPATH**/ ?>