        ...
        <form wire:submit="save">
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <div class="<?php echo e($activeTab === 'list' ? '' : 'd-none'); ?>">
                        <!-- Stats Cards -->
                        <div class="row g-3 mb-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="stat-card">
                                    ...
                                    <div class="stat-info">
                                        <h3><?php echo e($this->totalItems); ?></h3>
                                        <p>Total Items</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="stat-card">
                                    ...
                                    <div class="stat-info">
                                        <h3><?php echo e($this->activeItems); ?></h3>
                                        <p>Active Items</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="stat-card">
                                    ...
                                    <div class="stat-info">
                                        <h3><?php echo e($this->featuredItems); ?></h3>
                                        <p>Featured Items</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="stat-card">
                                    ...
                                    <div class="stat-info">
                                        <h3><?php echo e($this->totalCategories); ?></h3>
                                        <p>Categories</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-3 text-end">
                                        ...
                                        <span class="text-muted small"><?php echo e(count($selectedItems)); ?> selected</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6" 
                                    ...
                                    <div class="card fleet-card h-100 border-0 shadow-sm">
                                        <div class="fleet-card-img-wrap">
                                            ...
                                            <span class="fleet-status-badge <?php echo e($item->is_active ? 'active' : 'inactive'); ?>">
                                            ...
                                            <div class="fleet-action-overlay" x-show="showActions" x-transition>
                                                <div class="d-flex gap-1">
                                                    <button type="button" wire:click="viewDetails(<?php echo e($item->id); ?>)" 
                                                            class="btn btn-light btn-sm" title="View">
                                                        <i class="bi bi-eye"></i>
                                                    </button>
                                                    <button type="button" wire:click="edit(<?php echo e($item->id); ?>)" 
                                                            class="btn btn-primary btn-sm" title="Edit">
                                                        <i class="bi bi-pencil"></i>
                                                    </button>
                                                    <button type="button" wire:click="toggleFeatured(<?php echo e($item->id); ?>)" 
                                                            class="btn btn-<?php echo e($item->is_featured ? 'warning' : 'outline-warning'); ?> btn-sm" title="Featured">
                                                        <i class="bi bi-star<?php echo e($item->is_featured ? '-fill' : ''); ?>"></i>
                                                    </button>
                                                    <button type="button" wire:click="toggleStatus(<?php echo e($item->id); ?>)" 
                                                            class="btn btn-<?php echo e($item->is_active ? 'secondary' : 'success'); ?> btn-sm" title="Toggle Status">
                                                        <i class="bi bi-toggle-<?php echo e($item->is_active ? 'off' : 'on'); ?>"></i>
                                                    </button>
                                                    <button type="button" wire:click="confirmDelete(<?php echo e($item->id); ?>, 'item')" 
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="d-flex flex-wrap gap-1 mb-2">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = array_slice($item->features, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                        <span class="badge bg-light text-dark">
                                                            <i class="bi bi-dot text-success"></i> <?php echo e($feature); ?>

                                                        </span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($item->features) > 2): ?>
                                                        <span class="badge bg-light text-muted">+<?php echo e(count($item->features) - 2); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->manufacturer): ?>
                                                <small class="text-muted">
                                                    ...
                                                    <?php echo e($item->manufacturer); ?>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->model_number): ?> - <?php echo e($item->model_number); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </small>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>

                                        <div class="card-footer bg-white d-flex justify-content-between align-items-center">
                                            <small class="text-muted">Order: <?php echo e($item->sort_order); ?></small>
                    ...
                    <div class="<?php echo e($activeTab === 'form' ? '' : 'd-none'); ?>">
                        <div class="card shadow-sm border-0 mb-3">
                            <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0 fw-semibold">
                                    <i class="bi bi-<?php echo e($isEditing ? 'pencil-square' : 'plus-circle'); ?> me-2"></i>
                                    <?php echo e($isEditing ? 'Edit Fleet Item' : 'Add New Fleet Item'); ?>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select wire:model="fleet_category_id" class="form-select <?php $__errorArgs = ['fleet_category_id'];
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['fleet_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g., Hilti DD 250 Core Drill">
...
[$__name, $__params] = $__split('components.ck-editor', ['label' => 'Description','placeholder' => 'Enter detailed description...','height' => '300px','toolbar' => 'full','value' => $description,'field' => 'description','wire:model.live' => 'description']);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-254899507-0', $__key);
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="border rounded p-3 text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($imagePreview): ?>
                                                <img src="<?php echo e($imagePreview); ?>" class="img-fluid mb-2" style="max-height: 150px;">
                                            <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                                                    ...
                                                    <button type="button" wire:click="removeSpecification('<?php echo e($key); ?>')" 
                                    ...
                                    <div class="col-12 text-end mt-3 border-top pt-3">
                                        ...
                                        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                                            <span wire:loading.remove wire:target="save">
                                                <i class="bi bi-check-lg me-1"></i> <?php echo e($isEditing ? 'Update' : 'Create'); ?>
                    ...
                    <div class="<?php echo e($activeTab === 'categories' ? '' : 'd-none'); ?>">
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->icon): ?>
                                                            <i class="bi bi-<?php echo e($category->icon); ?> fs-5"></i>
                                                        <?php else: ?>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-secondary"><?php echo e($category->fleetItems()->count()); ?></span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <button type="button" wire:click="editCategory(<?php echo e($category->id); ?>)" class="btn btn-outline-primary">
                                                                <i class="bi bi-pencil"></i>
                                                            </button>
                                                            <button type="button" wire:click="confirmDelete(<?php echo e($category->id); ?>, 'category')" 
                                                                    class="btn btn-outline-danger"
                                                                    <?php if($category->fleetItems()->count() > 0): ?> disabled <?php endif; ?>>
                                                                <i class="bi bi-trash"></i>
                                                            </button>
                                                        </div>
                                                    </td>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="mb-3"><?php echo e($isEditingCategory ? 'Edit' : 'Add New'); ?> Category</h6>
                                        <div class="row g-3">
                                            <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="col-12 text-end">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEditingCategory): ?>
                                                ...
                                                <button type="button" wire:click="saveCategory" class="btn btn-info text-white">
                                                    ...
                                                    <?php echo e($isEditingCategory ? 'Update' : 'Create'); ?> Category
                                                </button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete <strong><?php echo e($deleteItemTitle); ?></strong>?</p>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDetailModal && $detailItem): ?>
    <div class="modal fade show d-block" tabindex="-1" style="background: rgba(0,0,0,0.5);">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="<?php echo e($detailItem->image_url); ?>" class="img-fluid rounded" alt="<?php echo e($detailItem->title); ?>">
                        </div>
                        <div class="col-md-6">
                            <h4><?php echo e($detailItem->title); ?></h4>
                            <div class="text-muted"><?php echo $detailItem->description; ?></div>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailItem->manufacturer): ?>
                                <p class="mt-3"><strong>Manufacturer:</strong> <?php echo e($detailItem->manufacturer); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailItem->model_number): ?>
                                <p><strong>Model:</strong> <?php echo e($detailItem->model_number); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailItem->category): ?>
                                <p><strong>Category:</strong> <?php echo e($detailItem->category->name); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailItem->features && count($detailItem->features) > 0): ?>
                                <h6 class="mt-3">Key Features:</h6>
                                <ul class="list-unstyled">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $detailItem->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <li><i class="bi bi-check-circle-fill text-success me-2"></i><?php echo e($feature); ?></li>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </ul>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailItem->specifications && count($detailItem->specifications) > 0): ?>
                                <h6 class="mt-3">Specifications:</h6>
                                <table class="table table-sm table-bordered">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $detailItem->specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <tr>
                                            <td class="fw-bold bg-light"><?php echo e($key); ?></td>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="edit(<?php echo e($detailItem->id); ?>)">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/admin/fleet/fleet-manager.blade.php ENDPATH**/ ?>