...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div wire:ignore>
                                    <textarea id="faq-answer-editor" class="form-control <?php $__errorArgs = ['faq_answer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e($faq_answer); ?></textarea>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button">
                                            <?php echo e($faq_question ?: 'Question preview...'); ?>
            ...
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    editor.model.document.on('change:data', () => {
                        ...
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('faq_answer', data, false);
