            ...
            <div class="row">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="faq-hero-subtitle">
                        <?php echo e($settings->site_tagline ?? 'Find answers to common questions about our services'); ?>
                    ...
                    <div class="faq-categories justify-content-center mb-4" data-aos="fade-up">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button class="faq-cat-btn" 
                                ...
                                <i class="fas fa-folder me-1"></i> <?php echo e($cat); ?>
                                    ...
                                    <div class="faq-item"
                                        ...
                                        <div class="faq-question" 
                                            ...
                                            <i class="fas fa-chevron-down faq-arrow" 
                                               :class="{ 'rotated': activeQuestion === <?php echo e($faq->id); ?> }"></i>
                                        </div>
                ...
                <div class="col-lg-8">
                    <div class="faq-cta">
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-center">
                            ...
                            <a href="<?php echo e(route('quote.index')); ?>" class="btn-faq-cta">
                                <i class="fas fa-file-invoice me-2"></i> Get Free Quote
                            </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <a href="tel:<?php echo e($primaryPhone); ?>" class="btn-faq-cta">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($whatsappClean): ?>
                            <a href="https://wa.me/<?php echo e($whatsappClean); ?>" target="_blank" class="btn-faq-cta" style="background:#25D366; color:#fff;">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/faq-page.blade.php ENDPATH**/ ?>