...
<div class="faq-page" 
    ...
    <div class="faq-mobile-cta d-lg-none">
        <a href="tel:<?php echo e($primaryPhone); ?>" class="faq-mobile-btn faq-mobile-call">
            <i class="fas fa-phone-alt"></i> Call
        </a>
        <a href="https://wa.me/<?php echo e($whatsappClean); ?>" target="_blank" class="faq-mobile-btn faq-mobile-whatsapp">
        ...
        <a href="<?php echo e(route('quote.index')); ?>" class="faq-mobile-btn faq-mobile-quote">
            ...
            <div class="row align-items-center min-vh-30">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <p class="faq-hero-subtitle">
                        <?php echo e($settings->site_tagline ?? 'Find answers to common questions about our engineering services'); ?>

                    </p>
                    
                    <div class="faq-hero-stats">
                        <div class="faq-stat-item">
                            <span class="faq-stat-number"><?php echo e(count($faqs)); ?>+</span>
                ...
                <div class="faq-search-wrapper" data-aos="fade-up">
                    <div class="faq-search-inner">
                        ...
                        <span class="faq-search-count">
                            <strong><?php echo e(count($faqs)); ?></strong> questions
                        </span>
                    </div>
                </div>
                    ...
                    <div class="faq-filters-wrapper" data-aos="fade-up">
                        <div class="faq-filters-scroll">
                            <button class="faq-filter-pill" 
                                ...
                                <span class="faq-filter-count"><?php echo e(count($faqs)); ?></span>
                            </button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                ?>
                                <button class="faq-filter-pill" 
                                        :class="{ 'active': activeCategory === '<?php echo e($cat); ?>' }"
                                        @click="filterCategory('<?php echo e($cat); ?>')">
                                    <?php echo e($cat); ?>

                                    <span class="faq-filter-count"><?php echo e($catCount); ?></span>
                                </button>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($faqs) && count($faqs) > 0): ?>
                        ...
                        <div x-ref="faqList">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="faq-item"
                                     x-show="matchesSearch(<?php echo \Illuminate\Support\Js::from($faq->toArray())->toHtml() ?>) && matchesCategory(<?php echo \Illuminate\Support\Js::from($faq->toArray())->toHtml() ?>)"
                                     :class="{ 'faq-item-active': activeQuestion === <?php echo e($faq->id); ?> }">
                                    
                                    <div class="faq-question" 
                                         @click="toggle(<?php echo e($faq->id); ?>)"
                                         role="button"
                                         tabindex="0"
                                         :aria-expanded="activeQuestion === <?php echo e($faq->id); ?>">
                                        <span class="faq-q-badge">Q</span>
                                        <span class="faq-q-text"><?php echo e($faq->faq_question); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($faq->faq_category): ?>
                                            <span class="faq-category-tag d-none d-md-inline-flex">
                                                <?php echo e($faq->faq_category); ?>

                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <i class="fas fa-chevron-down faq-chevron" 
                                           :class="{ 'rotate': activeQuestion === <?php echo e($faq->id); ?> }"></i>
                                    </div>
                                    
                                    <div class="faq-answer" 
                                         x-show="activeQuestion === <?php echo e($faq->id); ?>"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                        <div class="faq-cta-buttons">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showQuoteForm): ?>
                            <a href="<?php echo e(route('quote.index')); ?>" class="faq-btn faq-btn-accent">
                                <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                            </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <a href="tel:<?php echo e($primaryPhone); ?>" class="faq-btn faq-btn-white">
                                <i class="fas fa-phone-alt me-2"></i> <?php echo e($primaryPhoneFormatted); ?>
    ...
    <section class="faq-final-cta">
        <div class="container text-center">
            ...
            <div class="faq-final-cta-buttons">
                <a href="<?php echo e(route('quote.index')); ?>" class="faq-btn faq-btn-lg faq-btn-accent">
                    <i class="fas fa-paper-plane me-2"></i> Get Free Quote
                </a>
                <a href="tel:<?php echo e($primaryPhone); ?>" class="faq-btn faq-btn-lg faq-btn-white-outline-dark">
...
.faq-hero-bg {
    ...
    background: url('<?php echo e(asset("images/faq-hero-bg.jpg")); ?>') center/cover no-repeat;
...
</script><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/faq-page.blade.php ENDPATH**/ ?>