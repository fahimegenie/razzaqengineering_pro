<div>
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="mb-0 fs-3"><?php echo e($isEditing ? 'Edit Slider' : 'Create New Slider'); ?></h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-lg <?php $__errorArgs = ['s_title'];
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['s_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">
                                    Desktop Image 
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isEditing): ?><span class="text-danger">*</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </label>
                                <input type="file" 
                                       class="form-control <?php $__errorArgs = ['s_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       wire:model="s_image" 
                                       accept="image/*">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['s_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="position-relative mt-2">
                                    <img src="<?php echo e($imagePreview); ?>" class="img-thumbnail w-100" style="max-height: 150px; object-fit: cover;">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mobileImagePreview): ?>
                                <div class="position-relative mt-2">
                                    <img src="<?php echo e($mobileImagePreview); ?>" class="img-thumbnail w-100" style="max-height: 120px; object-fit: cover;">
                    ...
                    <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Overlay Opacity: <strong><?php echo e($overlay_opacity); ?>%</strong></label>
                    ...
                    <button type="submit" 
                        ...
                        <span wire:loading.remove wire:target="save">
                            ...
                            <?php echo e($isEditing ? 'Update Slider' : 'Create Slider'); ?>
                    ...
                    <a href="<?php echo e(route('admin.sliders.index')); ?>" class="btn btn-outline-secondary w-100">
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/admin/sliders/slider-form.blade.php ENDPATH**/ ?>