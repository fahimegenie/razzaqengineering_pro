        ...
        <section class="cra-hero">
            ...
            <div class="container position-relative">
                <div class="row" data-aos="fade-up">
                    <div class="col-lg-8">
                        <nav class="cra-breadcrumb"><ol><li><a href="<?php echo e(url('/')); ?>"><i class="fas fa-home me-1"></i> Home</a></li><li><a href="<?php echo e(route('careers')); ?>">Careers</a></li><li><a href="<?php echo e(route('careers.detail', ['slug' => $job->slug])); ?>"><?php echo e($job->title); ?></a></li><li class="active">Apply</li></ol></nav>
                        <h1 class="cra-hero-title">Apply for <?php echo e($job->title); ?></h1>
                        <div class="cra-hero-meta">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->department): ?><span><i class="fas fa-building"></i> <?php echo e($job->department); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-lg-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSuccess): ?>
                            <div class="cra-success-card" data-aos="fade-up">
                                ...
                                <a href="<?php echo e(route('careers')); ?>" class="cra-btn cra-btn-accent"><i class="fas fa-arrow-left me-2"></i> Back to Careers</a>
                            </div>
                        <?php else: ?>
                            <div class="cra-form-card" data-aos="fade-up">
                                <h2>Submit Your Application</h2>
                                <p class="cra-form-subtitle">Fill out the form below to apply for <strong><?php echo e($job->title); ?></strong></p>
                                
                                <form wire:submit="submitApplication" class="cra-form">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="cra-form-label">Full Name <span>*</span></label>
                                            <input type="text" wire:model.blur="name" class="cra-form-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Your full name">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <small class="cra-error-text"><?php echo e($message); ?></small> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" wire:model.blur="email" class="cra-form-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" wire:model.blur="phone" class="cra-form-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" wire:model="resume" class="cra-form-input <?php $__errorArgs = ['resume'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php else: ?>
        <section class="cra-main-section"><div class="container"><div class="cra-error-card"><i class="fas fa-exclamation-triangle" style="font-size:3rem;color:#dc3545;"></i><h4 class="fw-bold mt-3">Job Not Found</h4><p class="text-muted">This job posting may have expired.</p><a href="<?php echo e(route('careers')); ?>" class="btn btn-primary mt-3"><i class="fas fa-arrow-left me-2"></i> Back to Careers</a></div></div></section>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>

<style>
.cra-hero { position: relative; padding: 70px 0 50px; overflow: hidden; min-height: 280px; display: flex; align-items: center; }
.cra-hero-bg { position: absolute; inset: 0; background: url('<?php echo e(asset("images/careers-hero-bg.jpg")); ?>') center/cover no-repeat; filter: brightness(0.3); }
...
</style><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/career-apply-page.blade.php ENDPATH**/ ?>