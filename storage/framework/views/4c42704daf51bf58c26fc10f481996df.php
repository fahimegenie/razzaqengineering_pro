<div class="prd-page" 
    ...
    <div class="prd-mobile-cta d-lg-none">
        ...
        <a href="<?php echo e(route('quote.index')); ?>" class="prd-mobile-btn prd-mobile-quote">
                ...
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <div class="prd-hero-stats">
                        <div class="prd-stat-item">
                            <span class="prd-stat-number"><?php echo e($totalCount); ?>+</span>
                            <span class="prd-stat-label">Products</span>
                        </div>
                        <div class="prd-stat-item">
                            <span class="prd-stat-number"><?php echo e($categories->count()); ?>+</span>
        ...
        <div class="container">
            ...
            <?php else: ?>
                ...
                <div class="prd-section-header" data-aos="fade-up">
                    ...
                    <h2><?php echo e($selectedCategory !== 'all' ? $selectedCategoryName : 'All Products'); ?></h2>
                            ...
                            <div class="prd-input-wrapper prd-dropdown-wrapper">
                                ...
                                <div class="prd-dropdown-menu" x-show="open" x-transition>
                                    ...
                                    <div class="prd-dropdown-items">
                                        <button type="button" 
                                                class="prd-dropdown-item <?php echo e($selectedCategory === 'all' ? 'active' : ''); ?>"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filteredCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <button type="button" 
                                                    class="prd-dropdown-item <?php echo e($selectedCategory == $cat->pc_id ? 'active' : ''); ?>"
                        ...
                        <div class="col-lg-2 d-flex align-items-end">
                            <div class="d-flex align-items-center gap-2 w-100">
                                ...
                                <span class="prd-count-badge">
                                    <strong><?php echo e($totalCount); ?></strong> products
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalCount > 0): ?>
                    <div class="prd-products-grid" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'products-'.e($selectedCategory).'-'.e(md5($search)).''; ?>wire:key="products-<?php echo e($selectedCategory); ?>-<?php echo e(md5($search)); ?>">
                        <div class="row g-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="col-lg-3 col-md-4 col-sm-6" 
                                     data-aos="fade-up" 
                                     data-aos-delay="<?php echo e(($loop->index % 4) * 60); ?>" 
                                     <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'prd-'.e($product->id).''; ?>wire:key="prd-<?php echo e($product->id); ?>">
                                    <div class="prd-card <?php echo e($product->is_featured ? 'featured' : ''); ?>">
                                        <div class="prd-card-image">
                                            <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->p_name); ?>" loading="lazy">
                                            ...
                                            <div class="prd-card-overlay">
                                                <a href="<?php echo e(route('product.detail', ['slug' => $product->p_slug ?? $product->id])); ?>" class="prd-overlay-btn">
                                        ...
                                        <div class="prd-card-body">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->pc_type): ?>
                                                <span class="prd-card-category"><?php echo e($product->pc_type); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <h3>
                                                <a href="<?php echo e(route('product.detail', ['slug' => $product->p_slug ?? $product->id])); ?>"><?php echo e($product->p_name); ?></a>
                                            </h3>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->brand_name): ?>
                                                <div class="prd-card-brand">
                                                    <i class="fas fa-tag"></i> <?php echo e($product->brand_name); ?>

                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            
                                            <p><?php echo e(Str::limit($product->p_short_description ?? $product->p_description, 70)); ?></p>
                                            ...
                                            <div class="prd-card-footer">
                                                <a href="<?php echo e(route('product.detail', ['slug' => $product->p_slug ?? $product->id])); ?>" class="prd-card-link">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->p_contact): ?>
                                                    <a href="tel:<?php echo e($product->p_contact); ?>" class="prd-card-call">
                        ...
                        <div class="prd-load-more" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'load-more-'.e($loadedCount).''; ?>wire:key="load-more-<?php echo e($loadedCount); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasMore): ?>
                                ...
                                <p class="prd-load-info">Showing <?php echo e(count($products)); ?> of <?php echo e($totalCount); ?> products</p>
                            <?php else: ?>
                                <div class="prd-all-loaded">
                                    <i class="fas fa-check-circle"></i>
                                    <span>All <?php echo e($totalCount); ?> products loaded</span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
    ...
    <section class="prd-final-cta">
        <div class="container text-center">
            ...
            <div class="prd-final-cta-buttons">
                <a href="<?php echo e(route('quote.index')); ?>" class="prd-btn prd-btn-lg prd-btn-accent">
...
.prd-hero-bg {
    ...
    background: url('<?php echo e(asset("images/products-hero-bg.jpg")); ?>') center/cover no-repeat;
...
</script><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/products-page.blade.php ENDPATH**/ ?>