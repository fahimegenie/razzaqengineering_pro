  ...
  <div class="row">
    <div class="col-md-8 bg-light" id="work_space">
      <div id="containment" class="d-none d-md-inline">
        <img id="resize" src="<?php echo e($img->url); ?>" height="<?php echo e($height); ?>" width="<?php echo e($width); ?>">
      </div>
      <div id="resize_mobile" style="background-image: url(<?php echo e($img->url); ?>)" class="d-block d-md-none"></div>
    </div>
    <div class="col-md-4 pt-3">
      <table class="table table-compact table-striped">
        <thead></thead>
        <tbody>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scaled): ?>
          <tr>
      ...
      <div class="d-flex mb-3">
        ...
        <button class="btn btn-warning w-50 mr-1" onclick="doResizeNew()"><?php echo e(trans('laravel-filemanager::lfm.btn-resize-copy')); ?></button>
...
<?php /**PATH /var/www/html/projects/saif/razzaq-engineering/vendor/unisharp/laravel-filemanager/resources/views/resize.blade.php ENDPATH**/ ?>