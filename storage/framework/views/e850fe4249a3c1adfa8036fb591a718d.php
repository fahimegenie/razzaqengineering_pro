<div class="pdp-page" 
    ...
    <section class="pdp-hero">
        <div class="pdp-hero-bg" style="background-image: url('<?php echo e($product->image_url ?? asset('images/hero-products.jpg')); ?>');"></div>
        ...
        <div class="container position-relative">
            <div class="row align-items-center min-vh-30">
                <div class="col-lg-8" data-aos="fade-up">
                    <nav aria-label="breadcrumb">
                        <ol class="pdp-breadcrumb">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product && $product->pc_type): ?>
                                <li><a href="<?php echo e(url('products?category='.Str::slug($product->pc_type))); ?>"><?php echo e($product->pc_type); ?></a></li>
                    ...
                    <p class="pdp-hero-subtitle"><?php echo $product->p_short_description ?? 'High-quality engineering equipment from Razzaq Engineering Services.'; ?></p>
                    
                    <div class="pdp-hero-meta">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product && $product->brand_name): ?>
                            <span><i class="fas fa-tag"></i> Brand: <?php echo e($product->brand_name); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product && $product->pc_type): ?>
                            <span><i class="fas fa-th-large"></i> <?php echo e($product->pc_type); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <div class="pdp-hero-cta">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product && $product->p_contact): ?>
                            <a href="tel:<?php echo e($product->p_contact); ?>" class="pdp-btn pdp-btn-lg pdp-btn-white-outline">
                                <i class="fas fa-phone-alt me-2"></i> <?php echo e($product->p_contact); ?>
                ...
                <div class="col-lg-4 d-none d-lg-block text-center" data-aos="fade-left">
                    <div class="pdp-hero-image-wrapper">
                        <img src="<?php echo e($product->image_url ?? asset('images/product-default.jpg')); ?>" 
                             alt="<?php echo e($product->p_name ?? 'Product'); ?>" 
                        ...
                        <div class="pdp-content-card" data-aos="fade-up">
                            ...
                            <div class="pdp-content-body">
                                ...
                                <div class="pdp-description">
                                    <?php echo Str::words(strip_tags($product->p_description ?? ''), 80, '...'); ?>

                                </div>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->p_description && Str::wordCount(strip_tags($product->p_description)) > 80): ?>
                                ...
                                <div class="pdp-price-cta">
                                    <div class="pdp-price-display">
                                        ...
                                        <span class="pdp-price-value">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->p_price): ?>
                                                Rs. <?php echo e(number_format((float)$product->p_price)); ?>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->price_to): ?>
                                                    <span class="pdp-price-sep">-</span>
                                                    Rs. <?php echo e(number_format((float)$product->price_to)); ?>
                                    ...
                                    <a href="tel:<?php echo e($product->p_contact ?? '+923048902805'); ?>" class="pdp-btn pdp-btn-accent">
                                ...
                                <div class="pdp-info-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->brand_name): ?>
                                        <div class="pdp-info-item-card">
                                            <i class="fas fa-tag"></i>
                                            <span>Brand</span>
                                            <strong><?php echo e($product->brand_name); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->pc_type): ?>
                                        <div class="pdp-info-item-card">
                                            ...
                                            <span>Category</span>
                                            <strong><?php echo e($product->pc_type); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="pdp-info-item-card">
                                        <i class="fas fa-check-circle"></i>
                                        <span>Availability</span>
                                        <strong class="<?php echo e($product->in_stock ? 'text-success' : 'text-danger'); ?>">
                                            <?php echo e($product->in_stock ? 'In Stock' : 'Out of Stock'); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->p_contact): ?>
                                        <div class="pdp-info-item-card">
                                            ...
                                            <span>Contact</span>
                                            <strong><?php echo e($product->p_contact); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="pdp-content-card" data-aos="fade-up">
                                <div class="pdp-content-body">
                                    ...
                                    <div class="pdp-specs-table">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = array_slice($specifications, 0, $showAllSpecs ? count($specifications) : 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="pdp-spec-row">
                                                <span class="pdp-spec-key"><?php echo e($spec['key'] ?? $spec['label'] ?? 'Specification'); ?></span>
                                                <span class="pdp-spec-value"><?php echo e($spec['value'] ?? $spec ?? ''); ?></span>
                                            </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($specifications) > 6): ?>
                        ...
                        <div class="pdp-sidebar">
                            ...
                            <div class="pdp-sidebar-card">
                                ...
                                <div class="pdp-contact-list">
                                    <a href="tel:<?php echo e($product->p_contact ?? '+923048902805'); ?>" class="pdp-contact-item">
                                        <i class="fas fa-phone-alt"></i>
                                        <span><?php echo e($product->p_contact ?? '+92 304 8902805'); ?></span>
                                    </a>
                                ...
                                <div class="pdp-highlights">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->brand_name): ?>
                                        <div class="pdp-highlight-item">
                                            <i class="fas fa-tag"></i> Brand: <strong><?php echo e($product->brand_name); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="pdp-highlight-item">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->pc_type): ?>
                                        <div class="pdp-highlight-item">
                                            <i class="fas fa-th-large"></i> Category: <strong><?php echo e($product->pc_type); ?></strong>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div class="pdp-sidebar-card">
                                    ...
                                    <div class="pdp-related-list">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a href="<?php echo e(route('product.detail', ['slug' => $rp->p_slug ?? $rp->id])); ?>" class="pdp-related-item">
                                                <img src="<?php echo e($rp->image_url); ?>" alt="<?php echo e($rp->p_name); ?>" loading="lazy">
                                                <div>
                                                    <h6><?php echo e(Str::limit($rp->p_name, 30)); ?></h6>
                                                    <small>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rp->p_price): ?>
                                                            Rs. <?php echo e(number_format((float)$rp->p_price)); ?>
    ...
    <section class="pdp-final-cta">
        <div class="container text-center">
            ...
            <div class="pdp-final-cta-buttons">
                ...
                <a href="tel:<?php echo e($product->p_contact ?? '+923048902805'); ?>" class="pdp-btn pdp-btn-lg pdp-btn-white-outline-dark">
    ...
    <div class="pdp-gallery-modal" 
        ...
        <div class="pdp-gallery-content">
            <img src="<?php echo e((!empty($galleryImages) && isset($galleryImages[$activeGalleryImage])) ? asset($galleryImages[$activeGalleryImage]) : ''); ?>" 
                 alt="Gallery Image" 
...
</script><?php /**PATH /var/www/html/projects/saif/razzaq-engineering/resources/views/livewire/website/product-detail-page.blade.php ENDPATH**/ ?>